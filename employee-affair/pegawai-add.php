 ...
 <div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="7%" bgcolor="#f7fcff">Tanggal Lahir</th>
											  <th width="1%" bgcolor="#f7fcff">Pendidikan<br>Terakhir</th>
											  <th width="10%" bgcolor="#f7fcff">Pekerjaan </th>
											  <th width="7%" bgcolor="#f7fcff" rowspan="2">Upload File<br> ( Akta Nikah / Akta Kelahiran )</th>
 ...
 <div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="7%" bgcolor="#f7fcff">Jurusan / Fakultas</th>
											  <th width="6%" bgcolor="#f7fcff">Tahun Masuk</th>
											  <th width="6%" bgcolor="#f7fcff">Tahun Lulus</th>

											  <th width="10%" bgcolor="#f7fcff">Nama Sekolah / Universitas </th>
											  <th width="6%" bgcolor="#f7fcff" rowspan="2">Upload Ijazah</th>
											  <th width="1%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
 ...
 <div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="8%" bgcolor="#f7fcff">Uraian<br>Sertifikat</th>
											  <th width="8%" bgcolor="#f7fcff">Dikeluarkan Oleh</th>
											  <th width="5%" bgcolor="#f7fcff">Tahun<br>Sertifikat</th>

											
											  <th width="5%" bgcolor="#f7fcff" rowspan="2">Upload Sertifikat</th>
											  <th width="1%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
