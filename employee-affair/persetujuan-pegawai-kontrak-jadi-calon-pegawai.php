				...
				<span class="kt-subheader__separator kt-subheader__separator--v"></span>
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
											Persetujuan Pegawai Kontrak Jadi Calon Pegawai </span>
				...
				<form class="kt-form">
					<div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-lg-2">
                                <label class="">Verifikator :</label>
								  <select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="2" selected="">Verifikator - 1</option>
                                      <option value="2">Verifikator - 2</option>
                                      <option value="2">Verifikator - 3</option>
                                      <option value="2">Verifikator - 4</option>
                                  </select>
                             
                            </div>
							<div class="col-lg-3">
                                <label>Pegawai Verifikator :</label>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="15%" colspan="2" rowspan="2" bgcolor="#f7fcff">Pegawai</th>
											  <th width="20%" rowspan="2" bgcolor="#f7fcff">Jabatan</th>
											  <th width="2%" rowspan="2" bgcolor="#f7fcff">Pejabat<br>Pembuat</th>
											  <th width="7%" colspan="2" bgcolor="#f7fcff">Tanggal</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="7%" bgcolor="#f7fcff">Dibuat</th>
											  <th width="7%" bgcolor="#f7fcff">Diubah</th>
							              </tr>
										</thead>
										<tbody>
											<tr>
												<td>1</td>
												<td align="left" valign="left" style="text-align:left">VERIFIKATOR - 1</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000008" data-html="true"> <img src="../assets/media/users/100_16.jpg" alt="image" /> </a></td>
												<td align="left" valign="left" style="text-align:left">Sri Suhartini, SE</td>
												<td align="left" valign="left" style="text-align:left">Kepala Seksi Administrasi Kepegawaian </td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000008<hr>Sri Suhartini, SE<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
										  ...
										  <tr>
												<td>2</td>
												<td align="left" valign="left" style="text-align:left">VERIFIKATOR - 2</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000007" data-html="true"> <img src="../assets/media/users/100_16.jpg" alt="image" /> </a></td>
												<td align="left" valign="left" style="text-align:left">Muhammad Ramadhan Lerrick, ST</td>
												<td align="left" valign="left" style="text-align:left">Kepala Bagian Umum</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000008<hr>Sri Suhartini, SE<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
														<img src="../assets/media/users/100_16.jpg" alt="image">
													</a></td>
												<td align="center" valign="center" style="text-align:center">13 Agustus 2023</td>
										  ...
										  <tr>
												<td>3</td>
												<td align="left" valign="left" style="text-align:left">VERIFIKATOR - 3</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000004" data-html="true"> <img src="../assets/media/users/100_9.jpg" alt="image" /> </a></td>
												<td align="left" valign="left" style="text-align:left">Oklan Zulkifli, SE</td>
												<td align="left" valign="left" style="text-align:left">Direktur Umum</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000008<hr>Sri Suhartini, SE<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
														<img src="../assets/media/users/100_16.jpg" alt="image">
													</a></td>
												<td align="center" valign="center" style="text-align:center">13 Agustus 2023</td>
										  ...
										  <tr>
												<td>4</td>
												<td align="left" valign="left" style="text-align:left">VERIFIKATOR - 4</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000001" data-html="true"> <img src="../assets/media/users/100_15.jpg" alt="image" /> </a></td>
								...
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand flaticon2-list-1"></i></span>
												<h3 class="kt-portlet__head-title kt-font-bold">TAMBAH VERIFIKATOR</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="col-lg-6">
														<label>Uraian :</label>
														<input type="text" class="form-control form-control-sm" placeholder="VERIFIKATOR - 5" disabled>
								...
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand flaticon2-list-1"></i></span>
												<h3 class="kt-portlet__head-title kt-font-bold">EDIT VERIFIKATOR</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
