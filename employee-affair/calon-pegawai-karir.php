							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
									<div class="dropdown dropdown-inline" ddata-placement="left">
											<a href="calon-pegawai-data.php" class="btn btn-label-primary btn-sm" data-toggle="dropdown" onclick="goBack()">
							...
							<div>&nbsp;</div>
										...
										<tbody>
										  ...
										  <tr>
												...
												<td style="text-align:center"><button type="button" class="btn btn-outline-success btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download SK Calon Pegawai"><i class="fa flaticon-download-1"></i></button></td>
										  ...
										  <tr>
												...
												<td style="text-align:center"><button type="button" class="btn btn-outline-success btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download SK Kontrak"><i class="fa flaticon-download-1"></i></button></td>
							...
							<div>&nbsp;</div>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center"><button type="button" class="btn btn-outline-success btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download"><i class="fa flaticon-download-1"></i></button></td>
