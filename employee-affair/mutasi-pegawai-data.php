									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="m_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">No. SK Mutasi</th>
												<th width="10%" colspan="4" bgcolor="#f7fcff">Penerima Mutasi</th>
												<th width="20%" colspan="5" bgcolor="#fdfdec">Tujuan Mutasi</th>
										...
										<tbody>
											<tr>
												...
												<td width="1%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000001<hr>Umum<hr>Umum<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
