					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Status Pegawai</th>
										...
										<tbody>
											...
											<tr>
												<td width="1%">2</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Calon Pegawai</td>
										  ...
										  <tr>
												<td width="1%">3</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pegawai Kontrak</td>
										  ...
										  <tr>
												<td width="1%">4</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pegawai Honor</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH Status Pegawai</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
