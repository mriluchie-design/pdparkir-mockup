						...
						<div id="kt_aside_menu" class="kt-aside-menu kt-scroll ps ps--active-y" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" style="height: 820px; overflow: hidden;">
							...
							<li class="kt-menu__item " aria-haspopup="true"><a href="../index.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
								...
								<li class="kt-menu__section ">
									<h4 class="kt-menu__section-text">RECEPTIONS SYSTEM</h4>
									<i class="kt-menu__section-icon flaticon-more-v2"></i>
								</li>
								<li class="kt-menu__item " aria-haspopup="true"><a href="../reception/index.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
...
<li class="kt-menu__item " aria-haspopup="true"><a href="../reception/pengunjung.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g xmlns="http://www.w3.org/2000/svg" id="Stockholm-icons-/-Home-/-Door-open" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
</svg></span><span class="kt-menu__link-text">Pengunjung</span></a></li>
        ...
        <rect fill="#000000" opacity="0.3" x="10" y="17" width="7" height="2" rx="1"/>
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item" aria-haspopup="true"><a href="laporan-data-pengunjung.php" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Data Pengunjung</span></a></li>
											<li class="kt-menu__item" aria-haspopup="true"><a href="laporan-grafik-pengunjung" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Grafik Pengunjung</span></a></li>
