							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="pengunjung-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-users"></i> Tambah Pengunjung</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
							                      ...
							                      <div class="form-group row">
							                        <div class="col-lg-2">
							                          <label>Petugas Receptions :</label>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th colspan="2" bgcolor="#f7fcff">Resepsionis</th>
												<th colspan="3" bgcolor="#f7fcff">Tujuan Kunjungan</th>
												<th colspan="3" bgcolor="#feffed">Pengunjung</th>
												<th width="8%" bgcolor="#feffed" rowspan="2">Instansi</th>
												<th width="18%" bgcolor="#feffed" rowspan="2">Maksud Kunjungan</th>
												<th colspan="2" bgcolor="#feffed">Waktu Kunjungan</th>
											...
											<tr>
											  ...
											  <th width="4%" bgcolor="#f7fcff">Pegawai</th>
											  <th width="4%" bgcolor="#f7fcff">Department</th>
											  <th width="8%" bgcolor="#f7fcff">Bagian</th>
											  <th width="8%" bgcolor="#feffed">Nama</th>
											  <th width="15%" bgcolor="#feffed">Alamat</th>
											  <th width="6%" bgcolor="#feffed">No. Tlp / Wa</th>
											  <th width="9%" bgcolor="#feffed">Mulai </th>
												<th width="9%" bgcolor="#feffed">Berakhir </th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td id="kt_table_1">1</td>
												<td id="kt_table_1">002REPMRVIII2023</td>
											  ...
											  <td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Yulianti Tomu, SE&lt;hr&gt;Direktur Utama" data-html="true"> <img src="../assets/media/users/100_15.jpg" alt="image" /> </a></td>
											  <td align="left" valign="middle" style="text-align:center">Direksi</td>
											  <td align="left" valign="middle" style="text-align:center">Direksi</td>
											  <td style="text-align:left">Muhammad Nasrullah, S.Kom</td>
											  <td style="text-align:left">Jl. Toddopuli Raya Timur Kompleks Villa Surya Mas J/9</td>
											  <td style="text-align:left">082244444436</td>
											  <td style="text-align:left">PT. iLugroup Multimedia Indonesia</td>
												<td style="text-align:left">Instalasi Epass Management System PT. Pelabuhan Indonesia IV (Persero) Cabang Manado</td>
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--warning kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="On Progress" data-html="true">
															<i class="fa fa-user-clock kt_sweetalert_demo_9" data-html="true"></i>
														</span></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-pengunjung.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="tamu-keluar.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-file-export"></i>
																				<span class="kt-nav__link-text">Lapor Keluar</span>
																			</a>
																		</li>
										  ...
										  <tr>
												...
												<td id="kt_table_1">001REPMRVIII2023</td>
											  ...
											  <td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Yulianti Tomu, SE&lt;hr&gt;Direktur Utama" data-html="true"> <img src="../assets/media/users/100_15.jpg" alt="image" /> </a></td>
											  <td align="left" valign="middle" style="text-align:center">Pengembangan Usaha dan Kerjasama</td>
											  <td align="left" valign="middle" style="text-align:center">Pengembangan</td>
											  <td style="text-align:left">Muhammad Nasrullah, S.Kom</td>
											  <td style="text-align:left">Jl. Toddopuli Raya Timur Kompleks Villa Surya Mas J/9</td>
											  <td style="text-align:left">082244444436</td>
											  <td style="text-align:left">PT. iLugroup Multimedia Indonesia</td>
												...
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Keluar" data-html="true">
															<i class="fa fa-user-alt-slash kt_sweetalert_demo_9" data-html="true"></i>
														</span></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
