    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="mitra-insidentil-add.php" class="btn btn-info btn-sm">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"> <img src="../assets/media/users/100_1.jpg" alt="image" /> </a></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="cetak-id-card-jukir-insidentil.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"> <img src="../assets/media/users/100_2.jpg" alt="image" /> </a></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"> <img src="../assets/media/users/100_4.jpg" alt="image" /> </a></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
						...
						<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="20%" bgcolor="#f7fcff">Pegawai<br>yang menyerahkan</th>
											  <th width="20%" bgcolor="#f7fcff">Tanggal Penyerahan</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center" nowrap>13 Juli 2024 - 21:19 WITA</td>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="row">
								<div class="col-xl-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">History Serah Terima Rompi</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
