							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Profil Mitra Juru Parkir Insidentil
									</h3>
										...
										<div class="kt-portlet__body kt-portlet__body--fit-y">
											...
											<div class="kt-widget kt-widget--user-profile-1">
												<div class="form-group row" style="text-align:center">
																	<div class="col-lg-12">
														<label>Foto Mitra Jukir Insidentil :</label>
														<div>&nbsp;</div>
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="mitra-insidentil-detail.php" class="kt-widget__item">
														...
														<a href="data-penugasan-mitra-insidentil.php" class="kt-widget__item kt-widget__item--active">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<div class="kt-portlet__content">
												<div class="form-group row">
																					...
																					<div class="col-lg-6">
																						...
																						<input type="text" class="form-control form-control-sm" value="00001MJPI823" placeholder="= Pilih Tanggal =" id="kt_datepicker_2" disabled>
																					</div>
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
                     ...
                     <div class="form-group row">
						<div class="col-lg-12">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">QR Code Mitra Jukir Insidentil</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
																					<div class="col-lg-12">
