					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" bgcolor="#f7fcff">Qrcode<br>Mitra</th>
											  <th width="1%" bgcolor="#f7fcff">ID Mitra</th>
											  
											  <th width="1%" bgcolor="#f7fcff">Foto</th>
											  <th width="7%" bgcolor="#f7fcff">Nama Mitra</th>
										...
										<tbody>
											<tr>
												...
												<td width="2%" nowrap style="text-align:center">Biringkanaya</td>
												<td width="2%" nowrap style="text-align:center">I</td>
												<td width="2%" nowrap style="text-align:center">Coto Nusantara</td>
