							...
							<div class="col-lg-1">
                                <label class="">Kantor :</label>
                                 <select class="form-control kt-selectpicker" data-live-search="true">
                                      ...
                                      <option value="2">Cabang Sulawesi</option>
...
<!--begin:: Widgets/Stats-->
			...
			<div class="kt-portlet kt-portlet--mobile ">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="5%" bgcolor="#f7fcff">Periode Gaji</th>
											  <th width="1%" colspan="2" bgcolor="#f7fcff">Penerima</th>
											  <th width="7%" bgcolor="#f7fcff">Total Gaji</th>
											  <th width="7%" bgcolor="#f7fcff">Total Potongan</th>
											  <th width="7%" bgcolor="#f7fcff">Total Terbayar</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">101251720</td>
												<td nowrap="nowrap" style="text-align:center">2019</td>
												<td nowrap="nowrap" style="text-align:left">Januari</td>
												<td nowrap="nowrap" style="text-align:left">140</td>
												<td nowrap="nowrap" style="text-align:left">Pegawai</td>
												...
												<td class="text-center"><span class="btn btn-label-brand btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Pusat</span></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item" data-toggle="modal" data-target="#modal_bayar_gaji_sekaligus" data-skin="brand" data-html="true">
																			<a href="#" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-coins"></i>
																				<span class="kt-nav__link-text">Bayar Gaji Sekaligus</span>
																			</a>
																		</li>
																		
																		<li class="kt-nav__item">
																			<a href="print-slip-gaji-all.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Print Slip Gaji Sekaligus</span>
																			</a>
																		</li>
											...
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">102251720</td>
												<td nowrap="nowrap" style="text-align:center">2019</td>
												<td nowrap="nowrap" style="text-align:left">Februari</td>
												<td nowrap="nowrap" style="text-align:left">140</td>
												<td nowrap="nowrap" style="text-align:left">Pegawai</td>
												<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
											...
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">103251720</td>
												<td nowrap="nowrap" style="text-align:center">2019</td>
												<td nowrap="nowrap" style="text-align:left">Maret</td>
												<td nowrap="nowrap" style="text-align:left">139</td>
												<td nowrap="nowrap" style="text-align:left">Pegawai</td>
												<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="2.000.000.000" aria-describedby="basic-addon1" />
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">104251720</td>
												<td nowrap="nowrap" style="text-align:center">2019</td>
												<td nowrap="nowrap" style="text-align:left">April</td>
												<td nowrap="nowrap" style="text-align:left">137</td>
												<td nowrap="nowrap" style="text-align:left">Pegawai</td>
												<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="2.000.000.000" aria-describedby="basic-addon1" />
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">109251720</td>
												<td nowrap="nowrap" style="text-align:center">2019</td>
												<td nowrap="nowrap" style="text-align:left">September</td>
												<td nowrap="nowrap" style="text-align:left">135</td>
												<td nowrap="nowrap" style="text-align:left">Pegawai</td>
												<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="2.000.000.000" aria-describedby="basic-addon1" />
               ...
               <!--begin::Modal 1-->
							...
							<!--End::Modal 1-->
							<!--begin::Modal bayar gaji sekaligus-->
									<div class="modal fade" id="modal_bayar_gaji_sekaligus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-bold">FORM BAYAR GAJI PEGAWAI SEKALIGUS</h3>
											</div>
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Gaji</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
                       <div class="col-lg-3">
					   <label>ID</label>
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="101251720">
					   ...
					   <label>Penerima</label>
                         <div class="input-group input-group-sm">
														...
														<input type="text" class="form-control form-control-sm" placeholder="140" disabled aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">Pegawai</span></div>
													</div>
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Keterangan Pembayaran Gaji</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
                       <div class="col-lg-4">
						...
						<div class="col-lg-4">
                         ...
                         <div class="input-group input-group-sm">
								...
								<div class="col-xl-12">
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Penerima Penghasilan</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
										...
										<thead style="text-align:center">
											<tr>
												...
												<th width="10%" rowspan="2" bgcolor="#fdfdec">Pendapatan</th>
												<th width="10%" rowspan="2" bgcolor="#fdfdec">Potongan</th>
												<th width="10%" rowspan="2" bgcolor="#fdfdec">Diterima</th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi</th>
											</tr>
											<tr>
											  <th width="20%" colspan="2" bgcolor="#f7fcff">Detail Pegawai</th>
											  <th width="2%" bgcolor="#f7fcff">Kantor</th>
											  <th width="10%" bgcolor="#f7fcff">Status Pegawai</th>
										    </tr>
										</thead>
										<tbody>
											<tr>
												...
												<td width="4%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000001<hr>Umum<hr>Umum<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
												...
												<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>33.938.896,-</span> </div></td>
				...
				<button type="button" class="btn btn-brand btn-sm">
					...
					<span class="kt-hidden-mobile">Bayar Gaji</span>
							...
							<!--End::Modal bayar gaji sekaligus-->
							<!--begin::Modal 1-->
