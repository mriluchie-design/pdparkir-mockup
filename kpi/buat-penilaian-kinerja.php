									...
									<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="4%" rowspan="2" bgcolor="#f7fcff">Nilai Hasil</th>
										...
										<tbody>
										  ...
										  <tr>
										    ...
										    <td nowrap="nowrap" style="text-align:center">3</td>
										    <td rowspan="4" nowrap style="text-align:center"><input id="kt_touchspin_4" type="text" class="form-control form-control-sm bootstrap-touchspin-vertical-btn" value="" name="demo1" placeholder="2"></td>
										    <td rowspan="4" nowrap style="text-align:center"><div class="input-group input-group-sm">
													<input type="text" class="form-control m-input" style="text-align:right" disabled="disabled" placeholder="100" aria-describedby="basic-addon2">
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">
										  ...
										  <tr>
										    ...
										    <td nowrap="nowrap" style="text-align:center">3</td>
										    <td rowspan="4" nowrap style="text-align:center"><input type="number" class="form-control form-control-sm " disabled="disabled" placeholder="Tasking"></td>
										    <td rowspan="4" nowrap style="text-align:center"><div class="input-group input-group-sm">
													<input type="text" class="form-control m-input" style="text-align:right" disabled="disabled" placeholder="100" aria-describedby="basic-addon2">
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">
										  ...
										  <tr>
										    ...
										    <td nowrap bgcolor="#f7fcff" style="text-align:center"><input type="number" class="form-control form-control-sm " disabled="disabled" placeholder="Auto Calculation"></td>
							...
							<br>
										...
										<tbody>
										  ...
										  <tr>
										    ...
										    <td nowrap="nowrap" style="text-align:center">Tidak Ada</td>
										    <td nowrap="nowrap" style="text-align:center">0</td>
										    <td rowspan="7" nowrap style="text-align:center"><input type="number" class="form-control form-control-sm " disabled="disabled" placeholder="Tasking"></td>
										    <td rowspan="7" nowrap style="text-align:center"><div class="input-group input-group-sm">
													<input type="text" class="form-control m-input" style="text-align:right" disabled="disabled" placeholder="100" aria-describedby="basic-addon2">
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">
										  ...
										  <tr>
										    ...
										    <td nowrap="nowrap" style="text-align:center">Tidak Ada</td>
										    <td nowrap="nowrap" style="text-align:center">0</td>
										    <td rowspan="7" nowrap style="text-align:center"><input id="kt_touchspin_4" type="text" class="form-control form-control-sm bootstrap-touchspin-vertical-btn" value="" name="demo1" placeholder="2"></td>
										    <td rowspan="7" nowrap style="text-align:center"><div class="input-group input-group-sm">
													<input type="text" class="form-control m-input" style="text-align:right" disabled="disabled" placeholder="100" aria-describedby="basic-addon2">
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">
										  ...
										  <tr>
										    <td colspan="2" bgcolor="#f7fcff" id="kt_table_4" style="text-align:left">GRAND TOTAL SKOR PENILAIAN BEBAN KERJA</td>
