...
function goBack() {
  window.history.back();
	...
	<img src="../assets/img/header-potrait.png" style="width:787px; display:block; margin-left:0px;margin-right:auto;margin-bottom:40px;padding-top:0px;"/>
						<table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:-130px; margin-bottom:-100px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 12px;">
							<tr>
							  <th colspan="11" class="text-center">&nbsp;</th>
  </tr>
							
							<tr>
								<th colspan="11" class="text-center"><span style="font-family: Roboto; font-size: 12px;"><u>SURAT  KETERANGAN  BEKERJA</b></u></span><br /><span style="font-family: Roboto; font-size: 12px; margin-bottom:3rem">
