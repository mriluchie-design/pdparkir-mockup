...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
  ...
  <div class="col-xl-4">
	...
	<img src="../assets/img/header-potrait.png" style="width:793px; display:block; margin-left:0px;margin-right:auto;margin-bottom:40px;padding-top:0px;"/>
						<table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:-130px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 13px;">
							<tr>
  ...
  <table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:-130px; margin-top:100px; margin-bottom:-100px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 13px;">
							<tr>
							  <td width="3" valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer.png" style="width:834px; display:block; margin-left:auto; margin-top: 10px; margin-right:auto;margin-bottom:20px;padding-bottom:0px" />
					</div>
