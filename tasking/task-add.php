...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
												...
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_5">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Peraturan Daerah Kota Makassar Nomor 2 Tahun 2021 tentang Pendirian Perusahaan Umum Daerah Parkir Makassar Raya"></textarea></td>
																								...
																								<tr >
																								  <td style="text-align:center">3</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="SK. Walikota No. 7040 Tahun 1999 tentang Struktur Organisasi dan Tata Kerja Perusahaan Daerah Parkir Makassar Raya"></textarea></td>
																									<td style="text-align:center"><a href="javascript:;" data-repeater-delete="" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="dropdown"><i class="fa flaticon2-trash"></i></a></td>
  ...
  <div class="col-xl-4">
					  ...
					  <div class="col-lg-12">
                          ...
                          <textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Isikan Keterangan"></textarea>
                        </div>
