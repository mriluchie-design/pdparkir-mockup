...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
              ...
              <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Tugas</div><br>
										 <div class="kt-portlet__body">
					  ...
					  <div class="col-lg-2">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="23 Oktober 2025">
                        </div>
						<div class="col-lg-2">
                          <label class="">Tanggal Akhir Tugas :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="24 Oktober 2025">
                        </div>
					  ...
					  <div class="col-lg-3">
						...
						<div class="row">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Dasar Surat Tugas</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
												...
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_5">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Peraturan Daerah Kota Makassar Nomor 2 Tahun 2021 tentang Pendirian Perusahaan Umum Daerah Parkir Makassar Raya" disabled></textarea></td>
																									</tr>
																								<tr >
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="PERDA No.17 tahun 2006 tentang Pengelolaan Parkir Tepi Jalan Umum dalam Kota Makassar" disabled></textarea></td>
																									</tr>
																								<tr >
																								  <td style="text-align:center">3</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="SK. Walikota No. 7040 Tahun 1999 tentang Struktur Organisasi dan Tata Kerja Perusahaan Daerah Parkir Makassar Raya" disabled></textarea></td>
																									</tr>
  ...
  <div class="col-xl-4">
                      ...
                      <div class="form-group row">
                       <div id="kt_repeater_2">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_3">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Muhammad Nasrullah, S.Kom"></td>
																									</tr>
																								<tr data-repeater-item>
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Muhammad Nasrullah, S.Kom"></td>
                        ...
                        <div class="col-lg-12">
                          <div id="kt_repeater_2">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_2">
																								...
																								<tr style="text-align:center">
																								  <td width="10" bgcolor="#f7fcff">No</td>
																								  <td width="700" bgcolor="#f7fcff">Uraian</td>
																								   <td width="80" bgcolor="#f7fcff">Bobot</td>
																							      </tr>
																								<thead>
																									<tbody data-repeater-list="">
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Uraian Tugas 1" disabled></textarea></td>
																									<td style="text-align:center"><input type="text" class="form-control form-control-sm" placeholder="10" disabled></td>
																									</tr>
																								<tr data-repeater-item>
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Uraian Tugas 2" disabled></textarea></td>
																									<td style="text-align:center"><input type="text" class="form-control form-control-sm" placeholder="10" disabled></td>
																									</tr>
					  ...
					  <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
					  <div class="col-lg-12">
                          <label class="">Keterangan Lain :</label>
                          <textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Isikan Keterangan" disabled></textarea>
                        </div>
