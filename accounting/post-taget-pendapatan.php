	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				...
				&nbsp;
				&nbsp;
					Data Postingan Target Pendapatan
			</h3>
		</div>
...
<a href="target-pendapatan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus-circle"></i>Posting Target Pendapatan</button>
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
								<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
								                      ...
								                      <div class="form-group row">
																				<div class="col-lg-2">
																				 <label class="">ID Target Pendapatan :</label>
			...
			<!--end:: Widgets/Stats-->
																			...
																			<table class="table table-bordered table-hover">
																				<thead>
																					<tr>
																					  ...
																					  <th width="1%" rowspan="2" bgcolor="#f7fcff" class="tahun-anggaran">Tahun<br />Anggaran</th>
																					  <th width="1%" rowspan="2" bgcolor="#f7fcff" class="nomor">Tipe<br>Anggaran</th>
																					  <th width="1%" rowspan="2" bgcolor="#f7fcff" class="tahun-anggaran">ID Target<br />
																					    Pendapatan</th>
																					  <th width="12%" rowspan="2" bgcolor="#f7fcff" class="nomor">Department</th>
																					  <th width="4%" rowspan="2" bgcolor="#f7fcff" class="nomor">Kantor</th>
																					  <th width="1%" colspan="2" bgcolor="#f7fcff" class="nomor">Posting</th>
																					  <th width="1%" colspan="2" bgcolor="#f7fcff" class="nomor">Perubahan</th>
																					  <th width="22%" rowspan="2" bgcolor="#f7fcff" class="Keterangan">Keterangan</th>
																					  <th width="22%" rowspan="2" bgcolor="#f7fcff" class="Total">Total</th>
																						<th width="1%" rowspan="2" bgcolor="#f7fcff" class="Total">Status<br />
																						  Target</th>
																						<th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi</th>
																						<th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
																					</tr>
																					<tr>
																					  <th width="5%" bgcolor="#f7fcff" class="nomor">Oleh</th>
																					  <th width="12%" bgcolor="#f7fcff" class="nomor">Tanggal</th>
																					  <th width="5%" bgcolor="#f7fcff" class="nomor">Oleh</th>
																					  <th width="12%" bgcolor="#f7fcff" class="nomor">Tanggal</th>
																				  </tr>
																				</thead>
														...
														<img src="../assets/media/users/100_11.jpg" alt="image">
																					  ...
																					  <td nowrap="nowrap" class="table table-bordered table-hover" style="text-align:center"><button type="button" class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#modal_persetujuan_pending" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																			<a href="target-pendapatan-detail.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="target-pendapatan-edit.php" class="kt-nav__link">
														...
														<img src="../assets/media/users/100_11.jpg" alt="image">
																					  ...
																					  <td nowrap="nowrap" class="table table-bordered table-hover" style="text-align:center"><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="modal" data-target="#modal_persetujuan_release"data-html="true"> <i class="fa flaticon2-check-mark"></i> </span></td>
																					  <td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
