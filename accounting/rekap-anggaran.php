																			...
																			<table class="table table-bordered table-hover">
																				<thead>
																					<tr>
																					  ...
																					  <th width="25%" rowspan="2" bgcolor="#f7fcff" class="Keterangan">Keterangan</th>
																					  <th width="5%" rowspan="2" bgcolor="#f7fcff" class="Total">Status<br />Anggaran</th>
																						<th width="15%" rowspan="2" bgcolor="#f7fcff" class="Total">Total</th>
																				...
																				<tbody>
																					<tr>
																					  ...
																					  <td style="text-align:center" class="nomor">11 November 2023<br />
																					    21:24 WITA</td>
														...
														<img src="../assets/media/users/100_11.jpg" alt="image">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																			<a href="anggaran-detail.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="#.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak Rekap Anggaran</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="#.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak Rincian Anggaran</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="#" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak Target Pendapatan</span>
																			</a>
																		</li>
																		
																		<li class="kt-nav__item">
																			<a href="anggaran-edit.php" class="kt-nav__link">
