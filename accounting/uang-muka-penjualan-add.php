...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--height-full">
		<div class="kt-portlet__body">
			...
			<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
				<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Uang Muka</div><br>
				<div class="kt-portlet__body">
					<div class="kt-portlet__content">
						<div class="form-group row">
							<div class="col-lg-6">
								<label class="">Uang Muka: <code>*</code></label>
								<div class="input-group date">
							...
							<div class="col-lg-6">
								<label class="">No. PO: <code>*</code></label>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								<label class="">Kena Pajak: <code>*</code></label>
								<div class="form-group ">
								<label class="kt-checkbox">
											<input type="checkbox"> Kena Pajak
											<span></span>
