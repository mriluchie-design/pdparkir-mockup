					...
					<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
						...
						<div class="kt-portlet__body">
							<div class="kt-portlet__content">
								...
								<div class="form-group row">
									<div class="col-lg-6">
                          <label class="">Total Kas / Bank Asal  :</label>
                          <div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
...
<div class="col-lg-6">
                          <label class="">Total Kas / Bank Tujuan  :</label>
                          <div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																				...
																				<thead>
																					<tr>
																					  <th width="2%" bgcolor="#f7fcff">#</th>
																						<th width="15%" bgcolor="#f7fcff">Dibebankan Ke</th>
																						<th width="25%" bgcolor="#f7fcff">Uraian</th>
...
<tfoot style="border-top: 2px solid #5867dd">
																	<tr>
																		<th colspan="4" bgcolor="#f7fcff" class="text-right">Total</th>
