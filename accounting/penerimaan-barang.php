...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<i class="fa fa-plus"></i>Buat Penerimaan Barang</button>
...
<label class="dropdown-item"><input type="checkbox" name="noTerima" checked>No. Terima#</label>
...
<label class="dropdown-item"><input type="checkbox" name="alamat">Alamat</label>
...
<label class="dropdown-item"><input type="checkbox" name="tglPengiriman">Tgl Pengiriman</label>
<label class="dropdown-item"><input type="checkbox" name="keterangan" checked>Keterangan</label>
<label class="dropdown-item"><input type="checkbox" name="dapatDiproses">Dapat Diproses</label>
														...
														<div class="col-lg-3">
								                          <label>Status:</label>
																					<select class="form-control kt-selectpicker" multiple data-actions-box="true">
																						...
																						<option>Difaktur</option>
																						<option>Difaktur Sebagian</option>
																		...
																		<div class="kt-portlet__body">
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				...
																				<tbody>
																					<tr>
																						<td class="nomor"></td>
																						<td class="noTerima"></td>
																						<td class="tanggal"></td>
																						<td class="pemasok"></td>
																						<td class="alamat"></td>>
																						<td class="mataUang"></td>
																						<td class="pengiriman"></td>
																						<td class="tglPengiriman"></td>
																						<td class="keterangan"></td>
																						<td class="dapatDiproses"></td>
																						<td class="cabang"></td>
