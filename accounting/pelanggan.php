	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="pelanggan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Pelanggan</button>
...
<label class="dropdown-item"><input type="checkbox" name="idPelanggan" checked>ID Pelanggan</label>
<label class="dropdown-item"><input type="checkbox" name="kategori">kategori</label>
<label class="dropdown-item"><input type="checkbox" name="mataUang">Mata Uang</label>
<label class="dropdown-item"><input type="checkbox" name="syaratPemabayaran">Syarat Pembayaran</label>
...
<label class="dropdown-item"><input type="checkbox" name="kontakLiannya2">Kontak Lainnya #2</label>
...
<label class="dropdown-item"><input type="checkbox" name="kategoriPenjual">Kategori Penjual</label>
<label class="dropdown-item"><input type="checkbox" name="kategoriDiskon">Kategori Diskon</label>
<label class="dropdown-item"><input type="checkbox" name="saldo" checked>Saldo</label>
<label class="dropdown-item"><input type="checkbox" name="limitPiutang">Limit Piutang</label>
<label class="dropdown-item"><input type="checkbox" name="cabang">Cabang</label>
<label class="dropdown-item"><input type="checkbox" name="defaultPenjual">Default Penjual</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="idPelanggan">ID Pelanggan</th>
																						<th bgcolor="#f7fcff" class="kategori">Kategori</th>
																						<th bgcolor="#f7fcff" class="mataUang">Mata Uang</th>
																						<th bgcolor="#f7fcff" class="syaratPemabayaran">syarat Pembayaran</th>
																						...
																						<th bgcolor="#f7fcff" class="kontakLainnya1">Kontak Lainnya #!</th>
																						<th bgcolor="#f7fcff" class="pembuatData">Pembuat Data</th>
																						<th bgcolor="#f7fcff" class="nonAktif">Non Aktif</th>
																						<th bgcolor="#f7fcff" class="kategoriPenjual">Kategori Penjual</th>
																						<th bgcolor="#f7fcff" class="kategoriDiskon">Kategori Diskon</th>
																						<th bgcolor="#f7fcff" class="saldo">Saldo</th>
																						<th bgcolor="#f7fcff" class="limitPiutang">Limit Piutang</th>
																						<th bgcolor="#f7fcff" class="cabang">Cabang</th>
																						<th bgcolor="#f7fcff" class="defaultPenjual">Default Penjual</th>
																					</tr>
																				</thead>
																				<tbody>
																					<tr>
																						<td class="nama"></td>
																						<td class="idPelanggan"></td>
																						<td class="kategori"></td>
																						<td class="mataUang"></td>
																						<td class="syaratPemabayaran"></td>
																						...
																						<td class="kategoriPenjual"></td>
																						<td class="kategoriDiskon"></td>
																						<td class="saldo"></td>
																						<td class="limitPiutang"></td>
																						<td class="cabang"></td>
																						<td class="defaultPenjual"></td>
																				  </tr>
																					<tr>
																						<td class="nama"></td>
																						<td class="idPelanggan"></td>
