	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="target-penjualan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Target Penjualan</button>
...
<label class="dropdown-item"><input type="checkbox" name="tahun"> Tahun</label>
<label class="dropdown-item"><input type="checkbox" name="dariTanggal" checked> Dari Tanggal</label>
<label class="dropdown-item"><input type="checkbox" name="sampaiTanggal" checked>S/d Tanggal</label>
<label class="dropdown-item"><input type="checkbox" name="catatan">Catatan</label>
<label class="dropdown-item"><input type="checkbox" name="penganalisa">Penganalisa</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="DariTanggal">Dari Tanggal</th>
																						<th bgcolor="#f7fcff" class="sampaiTanggal">S/d Tanggal</th>
																				...
																				<tbody>
																					<tr>
																						<td class="tahun"></td>
																						<td class="dariTanggal"></td>
																						<td class="sampaiTanggal"></td>
																						<td class="catatan"></td>
