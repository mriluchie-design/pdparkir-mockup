	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="penerimaan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Penerimaan</button>
...
<label class="dropdown-item"><input type="checkbox" name="pemberi">Pemberi</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="pemberi">Pemberi</th>
