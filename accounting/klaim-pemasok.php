	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="klaim-pemasok-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Klaim Pemasok</button>
...
<label class="dropdown-item"><input type="checkbox" name="statusPengiriman" checked>Status Pengiriman</label>
														...
														<div class="col-lg-3">
								                          <label>Status:</label>
																					<select class="form-control kt-selectpicker" multiple data-actions-box="true">
																						...
																						<option>Diterima Seluruhnya</option>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="statusPengiriman">Status Pengiriman</th>
