			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
                                ...
                                <tr>
                                    <td colspan="7" style="text-align: center"><strong>NO : 110102.2025.II.01142</strong></td>
                                </tr>
                                <tr>
...
<table align="center" border="0" cellpadding="1" style="text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 12px; margin-top:10px; margin-left:70px; margin-bottom:50px;">
