...
<label class="dropdown-item"><input type="checkbox" name="NoTrans" checked>No.Trans#</label>
<label class="dropdown-item"><input type="checkbox" name="TipeTransaksi" checked>Tipe Transaksi</label>
<label class="dropdown-item"><input type="checkbox" name="dihapus">Dihapus</label>
</form>
</div>
				</div>
	</div>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="NoTrans">No. Trans#</th>
																						<th bgcolor="#f7fcff" class="TipeTransaksi">Tipe Transaksi</th>
																						<th bgcolor="#f7fcff" class="dihapus">Dihapus</th>
																					</tr>
																				</thead>
																				<tbody>
																					<tr onclick="document.location = 'log-aktivitas-jurnal-detail.php';">
																						<td class="tanggal">16/01/2020</td>
																						<td class="nomor">JV.2020.01.00001</td>
																						<td class="NoTrans">EXP.2020.01.00001</td>
																						<td class="TipeTransaksi">Pencatatan Beban</td>
																						<td class="dihapus">Tidak</td>
																				  </tr>
																</tbody>
																			</table>
