	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="pembayaran-pembelian-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Pembayaran Pembelian</button>
...
<label class="dropdown-item"><input type="checkbox" name="pemasok" checked>Pemasok</label>
...
<label class="dropdown-item"><input type="checkbox" name="rekeningBankPemasok">Rekening Bank Pemasok</label>
<label class="dropdown-item"><input type="checkbox" name="pemotonganPph">Pemotongan PPh</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="rekeningBankPemasok">Rekening Bank Pemasok</th>
																						<th bgcolor="#f7fcff" class="pemotonganPph">Pemotongan PPh</th>
																						...
																						<th bgcolor="#f7fcff" class="fakturDibayar">Faktur Dibayar</th>
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="void"></td>
																						<td class="cabang"></td>
																						<td class="rekeningBankPemasok"></td>
																						<td class="pemotonganPph"></td>
																						<td class="pembuatData"></td>
																						<td class="metodeBayar"></td>
																						<td class="nilaiPembayaran"></td>
																						<td class="fakturDibayar"></td>
																						<td class="diskon"></td>
