...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
  ...
  <tbody><tr style="text-align:center">
    ...
    <td width="10%" bgcolor="#f7fcff">MERK<br>/ TYPE</td>
  ...
  <tr>
    ...
    <td style="text-align:center"><button type="button" class="btn btn-outline-info btn-elevate btn-icon btn-icon btn-sm" data-toggle="modal" data-target="#modal_kantor" data-skin="brand" title="" data-html="true" data-original-title="Lihat Detail"><i class="fa fa-eye"></i></button> <button type="button" class="btn btn-outline-danger btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Ubah"><i class="fa fa-edit"></i></button> <button type="button" class="btn btn-outline-danger btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Hapus"><i class="fa fa-trash-alt"></i></button></td>
  </tr>
  <tr>
