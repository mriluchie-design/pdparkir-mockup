...
function goBack() {
  window.history.back();
											...
											<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_mitra_remove" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-user-slash"></i>Berhentikan Mitra</button>
											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="mitra-detail-remove.php" class="kt-widget__item">
														...
														<a href="data-penugasan-mitra.php" class="kt-widget__item kt-widget__item--active">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    <div class="kt-portlet__body">
                      <div class="row">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Penugasan</div><br><br>
										<div class="kt-portlet__body">
                     ...
                     <div class="form-group row">
						...
						<div class="col-lg-3">
																						...
																						<input type="text" class="form-control form-control-sm" value="06:00" placeholder="06:00:00 AM" disabled>
																					</div>
																					<div class="col-lg-3">
																						<label>Jam Akhir :</label>
																						<input type="text" class="form-control form-control-sm" value="17:00" placeholder="17:00:00 PM" disabled>
																					</div>
                     ...
                     <div class="form-group row">
						<div class="col-lg-6">
																						...
																						<input type="text" class="form-control form-control-sm" value="Biringkanaya" placeholder="Biringkanaya" disabled>
																					</div>
<div class="col-lg-6">
																						<label>Wilayah :</label>
																						<input type="text" class="form-control form-control-sm" value="Maricaya Baru" placeholder="Maricaya Baru" disabled>
																					</div>
																					</div>
...
<div class="col-xl-5">
									...
									<!--begin::Portlet-->
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
																							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Kolektor</div><br><br>
																							<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
																					<div class="col-lg-6">
...
<!--begin::Modal 1-->
									<div class="modal fade" id="modal_mitra_remove" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md" role="document">
									<div class="modal-content">

										<div class="modal-header">
										<span class="modal-title" id="exampleModalLabel"><span class="kt-badge kt-badge--danger kt-badge--inline"; style="color:#fff";>KETERANGAN</span></span>
