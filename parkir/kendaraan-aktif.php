					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="2%" bgcolor="#feffed">NFC Kendaraan</th>
											  <th width="2%" bgcolor="#feffed">Jenis<br />
											    Kendaraan</th>
											  <th width="2%" bgcolor="#feffed">Tanggal Expired</th>
											  <th width="2%" bgcolor="#feffed">Tipe Member</th>
											  <th width="2%" bgcolor="#feffed">Jenis Member</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">002DD516A51351</td>
												<td nowrap="nowrap" style="text-align:center"><span style="text-align:center">Mobil</span></td>
												...
												<td nowrap="nowrap" style="text-align:center"><span class="kt-badge kt-badge--primary kt-badge--md kt-badge--inline">Silver</span></td>
									...
									<a href="#" class="kt-nav__link" id="kt_sweetalert_demo_9">
										...
										<span class="kt-nav__link-text">Hapus</span>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center"><span style="text-align:center">Motor</span></td>
												<td nowrap="nowrap" style="text-align:center">24 September 2008</td>
												<td style="text-align:center"><button type="button" class="btn btn-label-success btn-sm">Pribadi</button></td>
