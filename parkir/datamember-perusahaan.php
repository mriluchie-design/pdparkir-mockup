    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="corporate-member-add.php" class="btn btn-info btn-sm">
                    <i class="fa fa-user-plus"></i> Registrasi Perusahaan</button>
                    <!--<i class="flaticon2-plus"></i>-->
                </a>
            </div>
        </div>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center"><button type="button" class="btn btn-label-brand btn-sm">Perusahaan</button></td>
