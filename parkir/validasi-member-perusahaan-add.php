							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Form Validasi Kendaraan Member Perusahaan
									</h3>
                        ...
                        <table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											...
											<tr style="text-align:center">
											  ...
											  <th width="2%" bgcolor="#f7fcff">ID<br /></th>
											...
											<div class="kt-portlet__content">
												<div class="form-group row">
																					...
																					<div class="col-lg-7">
																						...
																						<input type="text" class="form-control form-control-sm" value="Corporate - Platinum" placeholder="31 Desember 2022" id="kt_datepicker_2" disabled>
																					</div>
																					</div>
