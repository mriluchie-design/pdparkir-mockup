					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											...
											<tr style="text-align:center">
											  ...
											  <th width="2%" bgcolor="#f7fcff">Nama Titik Parkir</th>
											  <th width="2%" bgcolor="#f7fcff">Alamat Titik Parkir</th>
										...
										<tbody>
										  ...
										  <tr bgcolor="#feffed";>
										    <td colspan="9" id="kt_table_3" style="text-align:center" bgcolor="#feffed"><strong>Total Target</strong></td>
