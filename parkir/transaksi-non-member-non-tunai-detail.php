							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Detail Transaksi Non Member - Non Tunai
									</h3>
                    ...
                    <div class="kt-portlet__body">
					  ...
					  <div class="form-group row">
                       <div class="col-lg-4">
                          ...
                          <div class="form-group">
                        <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000001PNM823">
                      </div>
                        </div>
                        <div class="col-lg-4">
                          <label class="">Metode Pembayaran :</label>
                          <div class="form-group">
                        <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="e-Wallet">
                      </div>
                        </div>
						<div class="col-lg-4">
