									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="10%" rowspan="2" bgcolor="#f7fcff">Progress<br>Laporan</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center">12 Oktober 2019<br />
												  09:00 WITA</td>
												<td id="kt_table_1">003/SPPD/XII/2022</td>
												...
												<td align="center" valign="middle" style="text-align:center">Sorong</td>
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
											  <td style="text-align:left">Instalasi Epass System PT. Pelabuhan Indonesia IV Cabang Sorong</td>
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="laporan-perjalanan-dinas-add.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Buat Laporan</span>
																			</a>
																		</li>
																		...
																		<li class="kt-nav__item">
																			<a href="edit-laporan-perjalanan-dinas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon-edit-1"></i>
																				<span class="kt-nav__link-text">Edit Laporan</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
										  ...
										  <tr>
												...
												<td style="text-align:center">12 Oktober 2019<br />
												  09:00 WITA</td>
												<td id="kt_table_1">002/SPPD/XII/2022</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP : 000000000001<hr>Muhammad Nasrullah, S.Kom<hr>Direktur Utama" data-html="true">
														<img src="../assets/media/users/100_8.jpg" alt="image">
													</a></td>
												<td nowrap="nowrap" style="text-align:center"><button type="button" class="btn btn-outline-brand btn-sm" data-toggle="modal" data-target="#modal_perjalanan_dinas"><i class="fa fa-user-tie"></i>Lihat</button></td>
												<td align="center" valign="middle" style="text-align:center">Makassar</td>
												<td align="center" valign="middle" style="text-align:center">Manado</td>
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
											  <td style="text-align:left">Instalasi Epass System PT. Pelabuhan Indonesia IV Cabang Manado</td>
											  <td style="text-align:center" nowrap> <div class="progress">
								...
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-danger fa fa-user-tie"></i></span>
												<h3 class="kt-portlet__head-title kt-font-bold">DATA PEGAWAI PELAKSANA PERJALANAN DINAS</h3>
											</div>
						...
						<div class="card">
							<div class="card-header" id="headingOne">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1">
									Kantor Pusat
									<small>Pegawai Pelaksana Perjalanan Dinas</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingTwo">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
									Nama Cabang A
									<small>Pegawai Pelaksana Perjalanan Dinas</small> </div>
							</div>
