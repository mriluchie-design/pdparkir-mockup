                          ...
                          <div id="kt_repeater_2">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_2">
																							...
																							<tfoot>
																								<tr>
																									<td colspan="6">
																										<button type="button" class="btn btn-success btn-sm float-right" href="javascript:;" data-repeater-create=""> <i class="fa fa-plus-circle"></i> Tambah Data</button>
																									</td>
																								</tr>
																							</tfoot>
																						</table>
								...
								<div class="col-xl-4">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Form Surat Tugas</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
					  <div class="col-lg-6">
						...
						<div class="col-lg-6">
										<label class="">Penomoran Otomatis</label>
										<input class="kt-switch kt-switch--sm kt-switch--icon" data-switch="true" data-size="small" data-toggle="kt-tooltip" data-skin="brand" data-on-text="Otomatis" data-off-text="Tidak" data-on-color="success" type="checkbox" checked="checked">
...
<tr>
  ...
  <tr>
    ...
    <td><select class="form-control kt-selectpicker" data-live-search="true">
                              <option data-content="<a href='#' class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</a>" class="select-option-add" value="add"></option>
							  <option value="AK" selected>Tiket</option>
  ...
  <tr>
    ...
    <td colspan="2"><select class="form-control kt-selectpicker" data-live-search="true">
                              <option data-content="<a href='#' class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</a>" class="select-option-add" value="add"></option>
							  <option value="AK" selected>Transportasi</option>
