							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="perjalanan-dinas-form.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Buat Perjalanan Dinas</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
											  ...
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
											  <td style="text-align:left">Instalasi Epass System PT. Pelabuhan Indonesia IV Cabang Balikpapan</td>
