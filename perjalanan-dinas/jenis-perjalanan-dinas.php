				...
				<div class="kt-portlet__body">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												<td width="0.5%">1</td>
												<td width="1%" align="left" valign="left" style="text-align:left">Dalam Kota</td>
											...
											<tr>
												<td width="1%">2</td>
												<td width="1%" align="left" valign="left" style="text-align:left">Luar Kota</td>
										  ...
										  <tr>
												<td width="1%">3</td>
												<td width="1%" align="left" valign="left" style="text-align:left">Luar Negeri</td>
