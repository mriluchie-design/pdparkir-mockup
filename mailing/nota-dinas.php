						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="nota-dinas-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus"></i> Buat Nota Dinas</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="3%" rowspan="2" bgcolor="#f7fcff">Waktu<br>Input</th>
												
												<th width="1%" bgcolor="#f7fcff" rowspan="2">No. Nota Dinas</th>
												
												<th width="4%" bgcolor="#f7fcff" rowspan="2">Dari</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Kepada</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Perihal</th>

												<th width="2%" bgcolor="#f7fcff" rowspan="2">Status<br>Nota Dinas</th>
										...
										<tbody>
											<tr>
												...
												<td class="text-center"><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Belum</span></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="lihat-nota-dinas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Nota Dinas</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="sign-disposisi-nota-dinas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-file-signature"></i>
																				<span class="kt-nav__link-text">Disposisi Nota Dinas</span>
																			</a>
																		</li>
																			<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="edit-nota-dinas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon-edit-1"></i>
																				<span class="kt-nav__link-text">Edit Data</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="hapus-nota-dinas.php" class="kt-nav__link">
											...
											<tr>
												...
												<td class="text-center"><span class="btn btn-label-success btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Sudah</span></td>
