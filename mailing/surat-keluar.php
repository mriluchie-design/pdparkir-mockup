									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="4%" rowspan="2" bgcolor="#f7fcff">Waktu Input</th>
												
												<th width="4%" bgcolor="#f7fcff" rowspan="2">Jenis Surat</th>
												<th width="5%" bgcolor="#f7fcff" rowspan="2">Klasifikasi Surat</th>
											...
											<tr>
											  ...
											  <th width="6%" bgcolor="#f7fcff">Tanggal Surat Keluar</th>
