									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Dispositor</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Penerima Disposisi</th>

												<th width="1%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
											</tr>
											<tr>
											  <th width="1%" bgcolor="#f7fcff">No. Surat</th>
											  <th width="1%" bgcolor="#f7fcff">No Agenda Surat</th>
										...
										<tbody>
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Kamal Delapan<hr>Kabag SDM & Umum" data-html="true">
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-disposisi-surat-masuk.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="ekspedisi-surat-masuk.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Lembar Disposisi</span>
																			</a>
																		</li>
																		
																		<li class="kt-nav__item">
																			<a href="edit-disposisi-surat-masuk.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon-edit-1"></i>
																				<span class="kt-nav__link-text">Edit Data</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="hapus-disposisi-surat-masuk.php" class="kt-nav__link">
											...
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Kamal Delapan<hr>Direktur Keuangan" data-html="true">
