				...
				<div class="kt-portlet__body">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td align="left" valign="left" style="text-align:left">ID Setoran Petugas POS</td>
												<td align="left" valign="left" style="text-align:left">00001SPPK823</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH FORMAT NOMOR</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
