	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				...
				&nbsp;
				&nbsp;
				Form Tambah Petugas Pos Komersil
			</h3>
		</div>
                    ...
                    <div class="kt-portlet__body">
                      ...
                      <div class="row">
								<div class="col-xl-5">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Petugas Pos</div><br>
										<div class="kt-portlet__body">
...
<div class="col-lg-6">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Koordinator Pos</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
												<div class="col-lg-6">
...
<div class="col-lg-6">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">QR Code Petugas POS</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
