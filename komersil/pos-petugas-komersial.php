					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="20%" bgcolor="#f7fcff">Zona</th>
											  <th width="20%" bgcolor="#f7fcff">Nama POS</th>
										...
										<tbody>
											<tr>
												...
												<td align="left" valign="left" style="text-align:left">Biringkanaya</td>
												<td style="text-align:center" nowrap>-5.164227924842015</td>
												<td style="text-align:center" nowrap>119.45105984987575</td>
											...
											<tr>
												...
												<td align="left" valign="left" style="text-align:left">Bontoala</td>
												<td nowrap="nowrap" style="text-align:center">-5.164227924842015</td>
												<td nowrap="nowrap" style="text-align:center">119.45105984987575</td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH POS</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
                                      ...
                                      <option value="15">Wajo</option>
												...
												<div class="col-lg-1">
																					<label>Map :</label>
																					<button type="button" class="btn btn-sm btn-brand" data-toggle="modal" data-target="#modal_peta">Peta</button>
