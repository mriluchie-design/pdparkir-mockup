...
<div class="col-lg-2">
                               ...
                               <select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="1" selected="">Zaldy Amadha, A.Md</option>
                                      <option value="2">Suardi, S</option>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="8%" rowspan="2" bgcolor="#f7fcff">Nama Lengkap</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">NIK</th>
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Jabatan</th>
											  ...
											  <th width="1%" colspan="3" bgcolor="#feffed">Area Bertugas</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="5%" bgcolor="#f7fcff">Awal</th>
											  <th width="5%" bgcolor="#f7fcff">Berakhir</th>
											  <th width="8%" bgcolor="#feffed">Zona</th>
											  <th width="8%" bgcolor="#feffed">POS</th>
											  <th width="1%" bgcolor="#feffed">Koordinator<br>Lapangan</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
...
<td nowrap style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000000<hr>UMAR MALIK, SE<hr>082244444436" data-html="true">
...
<!--begin::Modal 1-->
									<div class="modal fade" id="modal-zona-pos" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="col-lg-4">
									...
									<select class="form-control kt-selectpicker" data-live-search="true">
                              <option value="2">000 000 001 - Zaldy Amadha, A.Md</option>
                              <option value="2">000 000 002 - Suardi S</option>
