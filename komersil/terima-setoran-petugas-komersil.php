		...
		<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-portlet kt-portlet--mobile ">
				...
				<div class="col-lg-8">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Pencarian</div><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
					  
						
					  <div class="col-lg-6">
                          <label class="">Koordinator Pos Komersil :</label>
...
<div class="row">
					  <div class="col-lg-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Petugas Pos Komersil</div><br><br>
										 <div class="kt-portlet__body">
													...
													<table class="table absen table-responsive table-striped- table-bordered table-hover table-checkable">
														...
														<tbody>
															...
															<tr>
															  ...
															  <td class="text-center"><span class="btn btn-label-brand btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="ID Reff : 01521531355135&lt;hr&gt;e-Wallet&lt;hr&gt;Gopay" data-html="true">Online</span></td>
