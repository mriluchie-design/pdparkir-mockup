...
var KTSweetAlert2Demo = function() {
    ...
    var initDemos = function() {
        ...
        $('.kt_sweetalert_demo_setuju').click(function(e) {
          swal.fire({
              title: 'Setujui?',
              ...
              if (result.value) {
                  swal.fire({
                      title: 'Apakah Anda Yakin Melakukan Penolakan?',
                      text: "Berikan Alasan!",
                      type: 'warning',
                      input:'textarea'
                  })
		...
		$('#kt_sweetalert_demo_12').click(function(e) {
            swal.fire({
                title: 'Apakah Anda Yakin?',
                text: "Pegawai Akan Diusulkan Menjadi Pegawai Tetap !",
                type: 'warning',
                showCancelButton: true,
                ...
                if (result.value) {
                    swal.fire(
                        'Terima Kasih !',
                        'Pegawai Telah Diusulkan Menjadi Pegawai Tetap.',
                        'success'
                    )
                    // result.dismiss can be 'cancel', 'overlay',
                    // 'close', and 'timer'
		...
		$('.kt_sweetalert_demo_13').click(function(e) {
          swal.fire({
              ...
              if (result.value) {
                  ...
                  swal.fire({
                      title: 'Apakah Anda Yakin Melakukan Persetujuan ?',
                      text: "Silahkan Tanda Tangan pada kotak dibawah, dan SK Pegawai Akan dibuatkan !",
                      type: 'success',
                      input:'textarea'
                  })
              }
