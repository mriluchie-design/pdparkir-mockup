...
<div class="tab-content" style="background:#f2f3f8;overflow:scroll;height:800px">
    ...
    <div style="width:100% !important;">
        <div style="float:right;margin-right: 30px">
            <table class="no-border" cellpadding="50" style="position:relative;top:-150px;">
                <tbody><tr>
    ...
    <br>
    <br>
    <div style="width:650px;margin:0 auto; position:relative; top:-150px;">
        ...
        <div style="line-height: 200%; width:650px; text-align:justify; line-height:1.5; font-family: Roboto;">
            Dengan ini mengajukan Permohonan [Jenis-Cuti] selama [Range-Date-Cuti] hari kerja terhitung mulai tanggal <b>[Tanggal-Awal-Cuti] s.d [Tanggal-Akhir-Cuti].</b>
	...
	<table class="no-border" style="display: inline-block;position:relative;top:-120px;float:right;margin-right:100px; margin-top:40px;" cellpadding="5">
                <tbody><tr>
				 ...
				 <tr>
                    <td valign="top" style="text-align: center"><img src="../assets/img/qrcode.jpg" width="75" height="75" /></td>
                </tr>
				 
                <tr>
                    <td style="text-align:center; padding-top:25px;">
                        [Nama Pegawai]<br>[Jabatan]</td>
                </tr>
