	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="print-index-cuti.php" class="kt-nav__link">
			...
			<a href="pegawai-cuti-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus-circle"></i>Pengajuan Cuti</button>
				<!--<i class="flaticon2-plus"></i>-->
			</a>
	...
	<div class="kt-portlet kt-portlet--mobile ">
		<div class="kt-portlet__head">
			...
			<div class="kt-portlet__head-toolbar">
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="modal" data-target="#saldo-cuti">
									...
									<ul class="kt-nav">
										...
										<li class="kt-nav__item">
											<a href="print-cuti.php" class="kt-nav__link">
												...
												<span class="kt-nav__link-text">Print Surat Permohonan</span>
											</a>
										</li>
										<li class="kt-nav__item">
											<a href="print-persetujuan-cuti.php" class="kt-nav__link">
												<i class="kt-nav__link-icon fa flaticon2-print"></i>
												<span class="kt-nav__link-text">Print Persetujuan Cuti</span>
											</a>
										</li>
										<li class="kt-nav__item">
											...
											<div class="kt-widget4">
												<div class="kt-widget4__item">
													<span class="kt-widget4__icon">
														<i class="flaticon-calendar kt-font-brand"></i>
													</span>
													<a href="#" class="kt-widget4__title kt-widget4__title--light">
														Cuti Alasan Penting
													</a>
													<span class="kt-widget4__number kt-font">Sisa Saldo&nbsp;&nbsp;&nbsp; <b><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">12 Hari</span></b></span>
												</div>
												<div class="kt-widget4__item">
													<span class="kt-widget4__icon">
