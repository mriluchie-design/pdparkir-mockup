						...
						<div class="col-lg-2">
                                <label class="">Tahun :</label>
																		...
																		<select class="form-control kt-selectpicker form-control" data-live-search="true">
					 																...
					 																<option value="AK"selected >2025</option>
                        ...
                        <table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="m_table_1">
										...
										<tbody>
										  ...
										  <tr>
											  ...
											  <td style="text-align:center">25</td>
											  <td style="text-align:center">25</td>
											  <td class="text-center"><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Atensi</span></td>
