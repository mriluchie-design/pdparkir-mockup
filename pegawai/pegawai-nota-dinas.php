    		                            ...
    		                            <span><i class="la la-search"></i></span>
												...
												<div class="col-lg-2">
						                          <label>Status Disposisi :</label>
																		<select class="form-control kt-selectpicker" data-live-search="true">
						                              <option value="2">Sudah Disposisi</option>
						                              <option value="3">Belum Disposisi</option>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Dibuat<br>Oleh</th>
												<th width="3%" rowspan="2" bgcolor="#f7fcff">Waktu Input</th>
												
												<th width="1%" bgcolor="#f7fcff" rowspan="2">No. Nota Dinas</th>
												
												<th width="5%" bgcolor="#f7fcff" rowspan="2">Dari</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Kepada</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Perihal</th>

												<th width="3%" bgcolor="#f7fcff" rowspan="2">Status Nota Dinas</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Status Disposisi</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left">Kabag SDM dan Umum</td>
												<td style="text-align:left">Direktur Utama</td>
												<td style="text-align:left">PENGADAAN AMPLOP SURAT DINAS</td>

												<td class="text-center"><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Belum Dibaca</span></td>
												<td class="text-center"><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Belum Ada Disposisi</span></td>
											...
											<tr>
												...
												<td class="text-center"><span class="btn btn-label-success btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Sudah Dibaca</span></td>
												<td class="text-center"><span class="btn btn-label-success btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">Sudah Ada Disposisi</span></td>
										  ...
										  <tr>
												...
												<td style="text-align:left">Kabag Keuangan</td>
												<td style="text-align:left">Direktur Utama</td>
