								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-lupa-absen-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-calculator"></i> Form Lupa Absen</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="6%" bgcolor="#f7fcff" rowspan="2">Jenis<br>Lupa Absen</th>
												<th width="6%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Pengajuan</th>
												<th width="6%" bgcolor="#f7fcff" rowspan="2">Tanggal<br>Lupa Absen</th>
												<th width="6%" bgcolor="#f7fcff" rowspan="2">Jam<br>Lupa Absen</th>
												<th width="30%" bgcolor="#f7fcff" rowspan="2">Keterangan Lupa Absen</th>
										...
										<tbody>
											...
											<tr>
												<td id="kt_table_1" style="text-align:center">2</td>
												<td>Pulang</td>
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center">12 Oktober 2019</td>
												<td style="text-align:center">09:00 WITA</td>
										  ...
										  <tr>
												<td id="kt_table_1" style="text-align:center">3</td>
												<td>Lembur Masuk</td>
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center">12 Oktober 2019</td>
												<td style="text-align:center">09:00 WITA</td>
										  ...
										  <tr>
												<td id="kt_table_1" style="text-align:center">4</td>
												<td>Lembur Keluar</td>
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center">12 Oktober 2019</td>
												<td style="text-align:center">09:00 WITA</td>
