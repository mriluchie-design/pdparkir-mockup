	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="print-index-izin.php" class="kt-nav__link">
			...
			<a href="pegawai-izin-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus-circle"></i> Pengajuan Izin</button>
				<!--<i class="flaticon2-plus"></i>-->
			</a>
	...
	<div class="kt-portlet kt-portlet--mobile ">
		<div class="kt-portlet__head">
			...
			<div class="kt-portlet__head-toolbar">
				<a href="pegawai-saldo-izin.php" class="btn btn-label-success btn-sm" data-toggle="modal" data-target="#saldo-izin">
									...
									<ul class="kt-nav">
										...
										<li class="kt-nav__item">
											<a href="hr-cetak-izin.php" class="kt-nav__link">
												...
												<span class="kt-nav__link-text">Print Persetujuan</span>
											</a>
										</li>
							...
							<div class="kt-portlet__body">
											...
											<div class="kt-widget4">
												<div class="kt-widget4__item">
													...
													<span class="kt-widget4__number kt-font">Sisa Saldo&nbsp;&nbsp;&nbsp; <span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="" data-html="true">12</span></span>
												</div>
												<div class="kt-widget4__item">
													<span class="kt-widget4__icon">
