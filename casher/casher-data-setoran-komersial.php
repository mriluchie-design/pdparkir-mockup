        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Rekap Setoran Koordinator POS Komersil
                </h3>
            </div>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="4%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Waktu<br />Transaksi</th>
											  <th width="3%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Tipe Transaksi</th>
											  <th width="2%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Koordinator<br />POS Komersil</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Kasir</th>
											  <th colspan="3" bgcolor="#feffed">Pembayaran</th>
											  <th width="12%" rowspan="2" bgcolor="#feffed">Jumlah Setoran</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="8%" bgcolor="#feffed">ID</th>
											  <th width="9%" bgcolor="#feffed">Metode</th>
											  <th width="9%" bgcolor="#feffed">Provider</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
												<td id="kt_table_1">1</td>
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:20:00 WITA</td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-casher-rekap-setoran-koordinator-pos.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="print-tanda-terima-koordinator-komersil.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:21:00 WITA</td>
...
<tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:22:00 WITA</td>
												<td class="text-center"><span class="btn btn-label-brand btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="ID Reff : 01521531355135<hr>e-Wallet<hr>Gopay" data-html="true">Non Tunai</span></td>
												<td nowrap="" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="02991MJPTJUVIII2025&lt;hr&gt;HARIS DAENG PAWA&lt;hr&gt;082244444436" data-html="true">
