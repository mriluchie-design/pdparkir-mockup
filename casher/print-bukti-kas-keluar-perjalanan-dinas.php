...
<tr>
  <td colspan="7" style="text-align: center">NO : 015/BKU/PERUMDA-PMR/XI/2025</td>
</tr>
<tr>
...
<tr>
  ...
  <table align="center" border="0" cellpadding="1" style="width: 625px; position:relative; top:-130px; margin-bottom:-160px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 12px;">
							...
							<tr>
							  ...
							  <td valign="top" style="text-align: center; border: 1px solid #ccc">NAMA PEGAWAI PERTAMA</td>
     </tr>
							<tr>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer.png" style="width:795px; display:block; margin-top:10px; margin-left:auto;margin-right:auto;margin-bottom:20px;padding-bottom:0px" />
					...
					<div class="tab-content" style="background:#f2f3f8;">
				<div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
					<div class="bg-white w-50 ml-auto mr-auto">
									<img src="../assets/img/header-potrait.png" style="width:795px; display:block; margin-left:0px;margin-right:auto;margin-bottom:20px;padding-top:0px;"/>
									<table align="center" border="0" cellpadding="1" width="625" style="text-align:left; line-height:1.5; font-family: Tahoma; font-size: 12px; position:relative;top:-160px;">
