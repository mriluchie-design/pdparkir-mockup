...
<div class="col-lg-3">
  ...
  <tbody><tr style="text-align:center">
    <td width="1%" bgcolor="#f7fcff">NO</td>
    <td width="12%" colspan="2" bgcolor="#f7fcff">URAIAN </td>
    <td width="13%" bgcolor="#f7fcff">JABATAN / GOLONGAN</td>
    <td width="3%" colspan="2" bgcolor="#f7fcff">VOL</td>
    <td width="10%" bgcolor="#f7fcff">ESTIMASI</td>
    <td width="10%" bgcolor="#f7fcff">REALISASI</td>
    <td width="10%" bgcolor="#f7fcff">SELISIH</td>
  </tr>
  <tr style="text-align:center">
