...
<div class="tab-content" style="background:#f2f3f8;overflow:scroll;height:800px">
	...
	<img src="../assets/img/header-potrait.png" style="width:787px; display:block; margin-left:0px;margin-right:auto;margin-bottom:40px;padding-top:0px;"/>
									<div>&nbsp;<div>
									<table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:-150px; text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 11px;">
...
<table align="center" border="1" cellpadding="1" style="width: 600px;  position:relative; top:-150px; text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 12px; border:1px solid black; border-collapse: collapse;">
                    <tbody><tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;" width="10">1.</td>
                    ...
                    <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;;" width="10">2.</td>
                    ...
                    <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;" width="10">3.</td>
                    ...
                    <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;" width="10">4.</td>
                        ...
                        <td style="border:1px solid black; padding-left:5px;" width="137">Dari : Kota Makassar
                            ...
                            <br>Transportasi Menggunakan: Pesawat Terbang
                                        ...
                                        <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;">5.</td>
                        ...
                        <td style="border:1px solid black; padding-left:5px;" width="137">Selama 3 hari
                            ...
                            7 Februari 2025
                                        ...
                                        <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;">6.</td>
                    ...
                    <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;">7.</td>
                    ...
                    <tr style="border:1px solid black;">
                        <td style="border:1px solid black; text-align:right; padding-right:5px;">8.</td>
                        ...
                        <td style="border:1px solid black; padding-left:5px;" width="137">Lihat Surat Tugas</td>
								...
								<div><span>&nbsp;</span>
   <table align="center" border="0" cellpadding="1" style="width: 600px;margin-bottom:-100px;  position:relative; top:-150px; text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 13px;">
							<tr>
  ...
  <table align="center" class="footnote-1" width="650px" style="margin-top:20px; position:relative; top:0px; padding-top:5px; ">
        <thead>
            <tr><th></th>
            <th></th>
            <th></th>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer.png" style="width:788px; display:block; margin-left:auto; position:relative; top:0px; margin-top: 10px; margin-right:auto;margin-bottom:20px;padding-bottom:0px" />
					</div>
...
<div class="bg-white w-50 ml-auto mr-auto">
	<img src="../assets/img/header-potrait.png" style="width:787px; display:block; margin-left:0px;margin-right:auto;margin-bottom:40px;padding-top:0px;"/>
									<div>&nbsp;<div>
									<table align="center" border="0" cellpadding="2" style=" width: 600px; text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 12px; position: relative; top:-120px">
						...
						<table align="center" border="1" cellpadding="1" style="width: 600px;   text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 12px; border:1px solid black; border-collapse: collapse; position: relative; top:-100px">
                            <tbody><tr style="border: 1px solid black">
						...
						<table align="center" border="1" cellpadding="1" style="width: 600px; margin-top:10px; text-align:justify; line-height:1.5; font-family: Tahoma; font-size: 12px;border:1px solid black; border-collapse: collapse; position: relative; top:-100px;">
                                <tbody><tr style="border: 1px solid black">
