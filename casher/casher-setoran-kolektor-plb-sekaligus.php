				...
				<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Target Bulan</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Waktu<br />Input</th>
											  <th width="10%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Kolektor</th>
											  <th colspan="3" bgcolor="#feffed">Data Transaksi</th>
											  <th colspan="2" bgcolor="#f7fcff">Status</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="2%" bgcolor="#feffed">ID Transaksi</th>
											  <th width="1%" bgcolor="#feffed">Customer<br>Membayar</th>
											  <th width="5%" bgcolor="#feffed">Total Setoran</th>
											  <th width="1%" bgcolor="#f7fcff">Kasir</th>
											  <th width="1%" bgcolor="#f7fcff">Bendahara<br />Penerimaan</th>
						                  </tr>
										</thead>
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Januari 2025<br />01:00:00 WITA</td>
												<td nowrap="nowrap" style="text-align:left">Umar Malik, SE</td>
												<td nowrap="nowrap" style="text-align:center">0001INVPLB1123</td>
												...
												<td width="1%" style="text-align:center" nowrap><button type="button" class="btn btn-outline-danger btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="Setoran Belum Diterima" data-html="true"><i class="fa fa-hand-holding-usd"></i></button></td>
												<td width="1%" style="text-align:center" nowrap><button type="button" class="btn btn-outline-danger btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-casher-rekap-setoran-kolektor-plb-sekaligus.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="cetak-tanda-terima-kolektor-plb.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">24 Desember 2024<br />01:00:01 WITA</td>
												<td nowrap="nowrap" style="text-align:left">Umar Malik, SE</td>
												<td nowrap="nowrap" style="text-align:center">0001INVPLB1123</td>
												...
												<td width="1%" style="text-align:center" nowrap><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Nama Kasir<hr>31 Desember 2018 - 14:30:00 WITA" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												<td width="1%" style="text-align:center" nowrap=""><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Disetujui<hr>Muhammad Nasrullah, S.Kom<br>31 Desember 2018 - 14:30 WITA">
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 November 2024<br />01:00:02 WITA</td>
												<td nowrap="nowrap" style="text-align:left">Leony Hesti Kilala</td>
												<td nowrap="nowrap" style="text-align:center">0002INVPLB1123</td>
												...
												<td width="1%" style="text-align:center" nowrap=""><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Disetujui<hr>Online Payment System<br>31 Desember 2018 - 14:30 WITA">
															<i class="fa flaticon2-check-mark"></i>
														</span></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
...
<tr>
												...
												<td nowrap="nowrap" style="text-align:center">2024</td>
												<td nowrap="nowrap" style="text-align:center">Oktober</td>
												<td nowrap="nowrap" style="text-align:center">23 Oktober 2024<br />01:00:04 WITA</td>
												<td nowrap="nowrap" style="text-align:left">Muslimin</td>
												<td nowrap="nowrap" style="text-align:center">0003INVPLB1123</td>
