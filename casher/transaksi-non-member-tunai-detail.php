							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Detail Transaksi Non Member - Tunai
									</h3>
                    ...
                    <div class="kt-portlet__body">
                      ...
                      <div class="form-group row">
                        <div class="col-lg-4">
                         ...
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000001PNMT823">
                        </div>
                        ...
                        <div class="input-group input-group-sm">
							...
							<!--end:: Portlet-->
								...
								<div class="col-xl-3">
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Mitra Jukir</div><br>
										<div class="kt-portlet__body">
                      <div class="form-group row">
                        <div class="col-lg-6">
                          <label>ID Mitra Jukir :</label>
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="00001MJTJU823">
                        </div>
						<div class="col-lg-6">
					  ...
					  <div class="form-group row">
						...
						<div class="col-lg-12">
                         ...
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Ayam Goreng Sulawesi">
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-lg-6">
                         ...
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="00001KJTJU823">
                        </div>
						<div class="col-lg-6">
                      ...
                      <div class="form-group row" style="text-align:center">
														...
														<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
																			<div class="kt-avatar__holder" style="background-image: url(&quot;../assets/media/users/alp.jpg&quot;);"></div>
