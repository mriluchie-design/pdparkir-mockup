        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Form Terima Setoran Koordinator POS Komersil
                </h3>
				<span class="kt-subheader__separator kt-subheader__separator--v"></span>
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
											YUNUS TULAK, S.IP [ Nama Koordinator Pos Komersil ]</span>
			...
			<div class="kt-portlet kt-portlet--mobile ">
				...
				<div class="form-group row">
					  ...
					  <div class="col-lg-2">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="0001KOMERSIL1125">
                        </div>
						<div class="col-lg-3">
                          <label class="">Waktu Transaksi :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="23 Agustus 2023 - 18:20:00 WITA">
                        </div>
						<div class="col-lg-3">
                          <label class="">Koordinator Pos :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="ADITYA BAMBANG HERMAWAN">
                        </div>
						<div class="col-lg-2" >
						...
						<div class="col-lg-2">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="0003PTTKOM823">
                        </div>
...
<div class="row">
					  <div class="col-lg-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Setoran Petugas Pos Komersil</div><br><br>
										 <div class="kt-portlet__body">
													...
													<table class="table absen table-responsive table-striped- table-bordered table-hover table-checkable">
														<thead style="text-align:center">
															...
															<tr>
															  ...
															  <th width="6%" bgcolor="#f7fcff">Metode</th>
