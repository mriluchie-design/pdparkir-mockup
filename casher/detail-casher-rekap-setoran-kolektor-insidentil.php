        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Detail Penerimaan Setoran Kolektor Insidentil
                </h3>
		...
		<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-portlet kt-portlet--mobile ">
				...
				<div class="form-group row">
					  ...
					  <div class="col-lg-4">
                          <label class="">ID Kolektor Insindetil :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="34978TKMINS102025">
                        </div>
						 <div class="col-lg-8">
                          <label class="">Nama Kolektor Insindetil :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="34978TKMINS102025">
                        </div>
						...
						<div class="col-lg-4">
						 ...
						 <div class="col-lg-4">
                          ...
                          <div class="input-group input-group-sm">
																					    ...
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="9.500.000" aria-describedby="basic-addon1">
...
<div class="row">
					  <div class="col-lg-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Jukir Insidentil</div><br><br>
										 <div class="kt-portlet__body">
													...
													<table class="table absen table-responsive table-striped- table-bordered table-hover table-checkable">
														<thead style="text-align:center">
															<tr>
															  ...
															  <th width="15%" rowspan="2" bgcolor="#f7fcff">Nama Jukir</th>
															  <th width="15%" rowspan="2" bgcolor="#f7fcff">Titik Parkir</th>
															  <th width="7%" rowspan="2" bgcolor="#feffed">Setoran</th>
															  ...
															  <td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	...
																	<li class="kt-nav__item">
																			<a href="detail-setoran-jukir-insidentil.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="print-tanda-terima-jukir-insidentil.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon2-print"></i>
																				<span class="kt-nav__link-text">Print Tanda Terima</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="edit-setoran-jukir--insidentil-kasir.php" class="kt-nav__link">
