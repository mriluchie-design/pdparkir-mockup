        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Setoran Kolektor Tepi Jalan Umum
                </h3>
            </div>
				...
				<form class="kt-form">
					<div class="kt-portlet__body">
                        <div class="form-group row">
							...
							<div class="col-lg-2">
                                <label>Verifikasi Bendahara :</label>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="4%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Tanggal Target</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Kolektor</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Jumlah Jukir</th>
											  <th colspan="5" bgcolor="#feffed">Transaksi</th>
											  <th colspan="2" bgcolor="#f7fcff">Verifikasi</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="8%" bgcolor="#feffed">ID</th>
											  <th width="4%" bgcolor="#feffed" id="kt_table_2">Tanggal<br /></th>
											  <th width="4%" bgcolor="#feffed">Waktu </th>
											  <th width="8%" bgcolor="#feffed">Jumlah</th>
											  <th width="3%" bgcolor="#feffed">Tipe</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												...
												<td nowrap="nowrap" style="text-align:center">0003PTTTJU823</td>
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												<td nowrap="nowrap" style="text-align:center">18:20:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><div class="input-group input-group-sm">
												  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
												  <input type="text" style="text-align:right" class="form-control form-control-sm" disabled="disabled" placeholder="14.000.000" aria-describedby="basic-addon1" />
												  <div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
												  </div>
												  </div>
												  </div></td>
												<td style="text-align:center"><button type="button" class="btn btn-label-danger btn-sm">Tunai</button></td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000003&lt;hr&gt;Yuni Saslia, SE&lt;hr&gt;Kasir TJU" data-html="true"> <img src="../assets/media/users/100_7.jpg" alt="image" /> </a></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-casher-rekap-setoran-kolektor-tju.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="cetak-tanda-terima-kolektor-tju.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td style="text-align:center"><button type="button" class="btn btn-label-danger btn-sm">Tunai</button></td>
												<td nowrap="nowrap" style="text-align:center"><button type="button" class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#modal_persetujuan_kasir_pending" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#modal_persetujuan_pending" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												<td nowrap="nowrap" style="text-align:center">18:21:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><div class="input-group input-group-sm">
												  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
												...
												<td style="text-align:center"><button type="button" class="btn btn-label-success btn-sm">Online</button></td>
...
<tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												<td nowrap="nowrap" style="text-align:center">18:22:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><div class="input-group input-group-sm">
												  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
												  <input type="text" style="text-align:right" class="form-control form-control-sm" disabled="disabled" placeholder="4.550.000" aria-describedby="basic-addon1" />
												  <div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
                ...
                <!--begin::Modal 1-->
							...
							<!--End::Modal 1-->
							<!--begin::Modal 1-->
									<div class="modal fade" id="modal_persetujuan_kasir_pending" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md" role="document">
									<div class="modal-content">

										<div class="modal-header">
										<span class="modal-title" id="exampleModalLabel"><span class="kt-badge kt-badge--danger kt-badge--inline"; style="color:#fff";>VERIFIKASI KASIR</span></span>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
										...
										<div class="kt-portlet__body">
											...
											<div class="tab-pane active" id="kt_widget4_tab1_content">
													<div class="kt-widget4">
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic"  data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000001" data-html="true">
																<img src="../assets/img/users/100_4.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nursiah,S.Kom
