							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Tanda Terima Setoran Customer PLB
									</h3>
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
                                ...
                                <tr>
                                    <td colspan="11" style="text-align: center"><u><b>TANDA TERIMA SETORAN PARKIR LANGGANAN BULANAN</b></u></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td width="7%">&nbsp;</td>
                                  <td>ID Customer PLB</td>
                                  <td style="text-align: center">:</td>
                                  <td colspan="3">0001MJPPLBVII24</td>
                                  </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td width="25%" style="text-align: left">15:58:16 WITA</td>
                                    ...
                                    <td width="150">Tarif Pengelolaan</td>
                                    <td width="1%" style="text-align: center">:</td>
                                    <td>Rp.</td>
                                    <td width="8%" style="text-align: right">1.000.000</td>
                                    <td>,-</td>
                                  </tr>
                                <tr>
                                  ...
                                  <td width="25%" style="text-align: left"> Tunai </td>
                                    <td width="7%" style="text-align: left">&nbsp;</td>
                                    <td width="150" style="text-align: left">Jumlah Setoran</td>
                                    <td width="1%" style="text-align: center">:</td>
                                    <td>Rp.</td>
                                    <td width="8%" style="text-align: right">1.000.000</td>
                                    <td>,-</td>
                                ...
                                <tr>
                                  ...
                                  <td style="text-align: left"><span style="text-align: center">:</span></td>
                                  <td width="25%" style="text-align: left">037KPPMRI2024 </td>
                                    <td width="7%" style="text-align: left">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td width="25%" style="text-align: left">M. Adi Wicaksana Irianto</td>
                                  <td width="7%" style="text-align: right">&nbsp;</td>
                                  <td width="150" style="text-align: left">Selisih Setoran</td>
                                  <td width="1%" style="text-align: center">:</td>
                                  <td>Rp.</td>
                                  <td width="8%" style="text-align: right">0</td>
                                  <td>,-</td>
