							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Tanda Terima Setoran Kolektor - Tepi Jalan Umum
									</h3>
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
                                ...
                                <tr>
                                    <td colspan="11" style="text-align: center"><u><b>TANDA TERIMA SETORAN KOLEKTOR - TEPI JALAN UMUM</b></u></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="125" style="text-align: left">ID Kolektor</td>
                                    <td style="text-align: left"><span style="text-align: center">:</span></td>
                                    <td style="text-align: left">037KPPMRI2024 </td>
                                  <td width="10%" style="text-align: right">&nbsp;</td>
                                    <td width="150" style="text-align: left">Nama Kolektor</td>
                                  <td width="1%" style="text-align: center"><span style="text-align: left">:</span></td>
