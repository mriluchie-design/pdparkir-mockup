									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="20%" bgcolor="#f7fcff" rowspan="2">No. SPPD</th>
												...
												<th width="12%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Input</th>
												<th colspan="2" bgcolor="#f7fcff">Kota</th>
												<th colspan="2" bgcolor="#f7fcff">Estimasi Perjalanan Dinas</th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi Perjalanan Dinas</th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Keuangan</th>
											...
											<tr>
											  ...
											  <th width="5%" bgcolor="#f7fcff">Tujuan</th>
												<th width="12%" bgcolor="#f7fcff">Mulai </th>
												<th width="12%" bgcolor="#f7fcff">Hingga </th>
												<th width="1%" bgcolor="#f7fcff">Estimasi</th>
												<th width="2%" bgcolor="#f7fcff">Realisasi</th>
											</tr>
										</thead>
										<tbody>
											<tr>
											  ...
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
												...
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Terbayar<hr>Yuni Saslia, SE<br>31 Desember 2018 - 14:30 WITA" data-html="true">
													<i class="fa fa-money-bill-wave-alt"></i>
														...
														<td nowrap style="text-align:center"><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>31 Desember 2018 - 14:30 WITA" data-html="true">
															<i class="fa flaticon2-check-mark"></i>
														</span></td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--danger kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Belum Dibuat" data-html="true">
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="edit-realisasi-perjalanan-dinas.php" class="kt-nav__link">
											  ...
											  <td align="center" valign="middle" style="text-align:center">12 Oktober 2019</td>
												...
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Terbayar<hr>Yuni Saslia, SE<br>31 Desember 2018 - 14:30 WITA" data-html="true">
													<i class="fa fa-money-bill-wave-alt"></i>
														...
														<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Sudah Dibuat<hr>31 Desember 2018 - 14:30 WITA" data-html="true">
															<i class="fa fa-calculator"></i>
														</span></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
