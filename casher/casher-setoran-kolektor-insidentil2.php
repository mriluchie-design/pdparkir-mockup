        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Rekap Setoran Kolektor Tepi Jalan Umum
                </h3>
            </div>
					...
					<div class="kt-portlet__body">
                        <div class="form-group row">
							...
							<div class="col-lg-2">
                                ...
                                <select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="1" selected="">Bank Central Asia</option>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="3%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Waktu<br />Transaksi</th>
											  <th width="3%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Tanggal Target</th>
											  <th width="4%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Tipe</th>
											  <th width="2%" rowspan="2" bgcolor="#f7fcff" id="kt_table_2">Kolektor</th>
											  <th width="2%" rowspan="2" bgcolor="#f7fcff">Kasir</th>
											  <th colspan="2" bgcolor="#feffed">Pembayaran</th>
											  <th width="8%" rowspan="2" bgcolor="#feffed">Jumlah Setoran</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="10%" bgcolor="#feffed">ID</th>
											  <th width="10%" bgcolor="#feffed">Provider</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
												<td id="kt_table_1">1</td>
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:20:00</td>
												...
												<td nowrap="" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000003&lt;hr&gt;Yuni Saslia, SE&lt;hr&gt;Kasir TJU" data-html="true">
														<img src="../assets/media/users/100_7.jpg" alt="image">
													</a></td>
												<td nowrap="nowrap" style="text-align:center">0003PTTTJU823<hr>Tunai</td>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:21:00</td>
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												<td style="text-align:center"><button type="button" class="btn btn-label-brand btn-sm">Non Tunai</button></td>
												...
												<td nowrap="nowrap" style="text-align:center">0002PNTTJU823<hr>Bank Transfer</td>
...
<tr>
												...
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023<hr>18:22:00</td>
												<td nowrap="nowrap" style="text-align:center">23 Agustus 2023</td>
												<td style="text-align:center"><button type="button" class="btn btn-label-brand btn-sm">Non Tunai</button></td>
												<td nowrap="" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="02991MJPTJUVIII2025&lt;hr&gt;HARIS DAENG PAWA&lt;hr&gt;082244444436" data-html="true">
												...
												<td style="text-align:center"><button type="button" class="btn btn-label-success btn-sm">Online</button></td>
												<td nowrap="nowrap" style="text-align:center">0001PNTTJU823<hr>eWallet</td>
