                  ...
                  <div class="kt-portlet__body">
										...
										<tbody>
											...
											<tr>
												...
												<td align="center" valign="middle" bgcolor="#F3F8FF" style="text-align:center"><strong>0</strong></td>
												<td align="center" valign="middle" bgcolor="#F3F8FF" style="text-align:center"><strong>0</strong></td>
												<td align="center" valign="middle" style="text-align:center"><button type="button" class="btn btn-outline-brand btn-sm btn-icon" data-toggle="modal" data-target="#modal_view_absen" data-html="true"><i class="fa fa-eye"></i></button></td>
										  </tr>
											<tr>
...
<tr>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-bold">LAPORAN ABSEN PEGAWAI</h3>
											</div>
  ...
  <tr>
    <td width="13%" rowspan="3"><a href="#" style="text-align:center" class="kt-media"><img src="../assets/img/users/100_15.jpg" alt="image" style="max-width:100px; line-height:1px; !important;height:auto" /></a></td>
...
<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
  ...
  <tr>
    <td>Foto</td>
    <td>:</td>
    <td><button type="reset" class="btn btn-outline-brand btn-sm"><i class="flaticon-eye"></i>Lihat Foto</button></td>
    <td>Foto</td>
    <td>:</td>
    <td><button type="reset" class="btn btn-outline-brand btn-sm"><i class="flaticon-eye"></i>Lihat Foto</button></td>
  </tr>
