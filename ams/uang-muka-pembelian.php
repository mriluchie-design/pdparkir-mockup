	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="uang-muka-pembelian-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Uang Muka Pembelian</button>
...
<label class="dropdown-item"><input type="checkbox" name="uangMuka">Uang Muka Terpakai</label>
...
<label class="dropdown-item"><input type="checkbox" name="hutangPajak">Hutang Pajak</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="uangMuka">Uang Muka Terpakai</th>
