	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="tukar-faktur-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Tukar Faktur</button>
...
<label class="dropdown-item"><input type="checkbox" name="tenagaPenjual">Tenaga Penjual</label>
<label class="dropdown-item"><input type="checkbox" name="tanggal" checked>Tanggal</label>
<label class="dropdown-item"><input type="checkbox" name="tglTukar" checked>Tgl Tukar</label>
...
<label class="dropdown-item"><input type="checkbox" name="totalFaktur">Total Faktur</label>
</form>
</div>
				</div>
	</div>
														...
														<div class="col-lg-3">
								                          <label>Status:</label>
																					<select class="form-control kt-selectpicker" multiple data-actions-box="true">
																						...
																						<option>Draf</option>
																						<option>Sedang Diporoses</option>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="tenagaPenjual">Tenaga Penjual</th>
																						<th bgcolor="#f7fcff" class="tanggal">Tanggal</th>
																						<th bgcolor="#f7fcff" class="tglTukar">Tgl Tukar</th>
																						...
																						<th bgcolor="#f7fcff" class="totalFaktur">Total Faktur</th>
																					</tr>
																				</thead>
																				<tbody>
																					<tr>
																						<td class="pelanggan"></td>
																						<td class="tenagaPenjual"></td>
																						<td class="tanggal"></td>
																						<td class="tglTukar"></td>
																						<td class="nomor"></td>
																						<td class="cabang"></td>
