					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                      ...
                      <div class="form-group row">
                       <div class="col-lg-12">
                          ...
                          <input type="text" class="form-control form-control-sm" placeholder="Alat Penghitung Uang Kertas">
                        </div>
...
<div class="col-lg-12">
                          ...
                          <div class="form-group">
                         <textarea class="form-control" id="exampleTextarea" rows="2" style="margin-top: 0px; margin-bottom: 0px; height: 55px;">RUANGAN PERLENGKAPAN KEADAAN FISIK BARANG BAGIAN DEPAN BAIK ,BAGIAN  BELAKANG  DAN BAWAH RUSAK BERAT</textarea>
                      </div>
                        </div>
