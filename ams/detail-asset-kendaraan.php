              ...
              <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Informasi Umum</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-6">
                          <label>Nama Asset :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="SEPEDA MOTOR" disabled>
                        </div>
						<div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                          <label>Merk / Type :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="YAMAHA" disabled>
                        </div>
						
						
						<div class="col-lg-6">
                          <label>Warna :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="Hitam" disabled>
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
                      <div class="col-lg-6">
                          <label>No. Rangka :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="MH3SG3120HK267212" disabled>
                        </div>
						
						
						<div class="col-lg-6">
                          <label>No. Mesin :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="G3E4E-0379819" disabled>
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
                      <div class="col-lg-6">
                          <label>No. Plat :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="DD 6043 KC" disabled>
                        </div>
						
						
						<div class="col-lg-6">
                          <label>No. BPKB :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="20267212" disabled>
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
<div class="col-lg-6">
                         ...
                         <input type="text" class="form-control form-control-sm" placeholder="01/01/2024" disabled>
                      </div>
                        </div>
						<div class="col-lg-6">
					...
					<div class="col-xl-3">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Informasi Keuangan</div><br><br>
										 <div class="kt-portlet__body">
...
<div class="col-lg-12">
						  ...
						  <input type="text" class="form-control form-control-sm" placeholder="Tidak Terdepresiasi" disabled>
						...
						<div class="col-lg-6">
                          ...
                          <div class="input-group input-group-sm">
														...
														<input type="text" class="form-control form-control-sm" placeholder="4" aria-describedby="basic-addon1" disabled>
						...
						<div class="col-lg-6">
                          <label>&nbsp;</label>
                           <div class="input-group input-group-sm">
														...
														<input type="text" class="form-control form-control-sm" placeholder="6" aria-describedby="basic-addon1" disabled>
...
<div class="col-lg-12">
                          ...
                          <input type="text" class="form-control form-control-sm" placeholder="Aset Lancar" disabled>
                        </div>
...
<div class="col-lg-12">
					...
					<div class="col-xl-3">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Asset</div><br><br>
										 <div class="kt-portlet__body">
...
<div class="col-lg-5">
                          <label>Volume :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="12" disabled>
                        </div>
						<div class="col-lg-7">
                          <label>Satuan :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="Unit" disabled>
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
						<div class="col-lg-12">
                          <label>Harga Perolehan :</label>
                           <div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="5.000.000" aria-describedby="basic-addon1" disabled>
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div>
                        </div>
					  ...
					  <div class="form-group row">
						<div class="col-lg-12">
                          <label>Keadaan Barang :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="Baik" disabled>
                        </div>
					...
					<div class="col-xl-2">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
																			...
																			<div class="kt-avatar__holder" style="background-image: url(&quot;../assets/img/illustrations/camera.jpg&quot;);"></div>
																			...
																			<span class="kt-avatar__cancel" data-toggle="kt-tooltip" title="" data-original-title="Cancel Foto">
																				<i class="fa fa-times"></i>
																						...
																						<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
																							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">QR Code Asset</div><br>
																							<div class="kt-portlet__body">
																								<div class="kt-portlet__content">
																									<div class="form-group row" style="text-align:center">
																										<div class="col-lg-12">
							...
							<!--end:: Portlet-->
								...
								<div class="col-xl-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Akun Pengeluaran</div><br><br>
										 <div class="kt-portlet__body">
																				...
																				<thead>
																					<tr>
																					  <th width="2%" bgcolor="#f7fcff">#</th>
																						...
																						<th width="5%" bgcolor="#f7fcff">Lampiran Dokumen</th>
																				...
																				<tbody>
																					<tr>
																					  <td style="text-align:right"; align="center">1</td>
																						<td align="center"><input type="text" class="form-control form-control-sm" placeholder="Asset Lancar" disabled></td>
																						<td><input type="text" class="form-control form-control-sm" placeholder="15 Februari 2024" disabled></td>
																						<td><input type="text" class="form-control form-control-sm" placeholder="Isi Catatan" disabled></td>
																						<td align="center"><a href="javascript:;" data-repeater-delete="" class="btn btn-success btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="default" title="" data-html="true" data-original-title="Download Dokumen"><i class="fa fa-file-download"></i></a></td>
