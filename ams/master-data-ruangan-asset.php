					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" bgcolor="#f7fcff" id="kt_table_2">Kode Ruangan</th>
											  <th width="30%" bgcolor="#f7fcff">Nama Ruangan</th>
										...
										<tbody>
											<tr>
												<td width="0.5%">1</td>
												<td width="0.5%">12.22.20.22.04.11.01</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Dirut</td>
										  ...
										  <tr>
												<td width="0.5%">2</td>
												<td width="0.5%">12.22.20.22.04.11.02</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Dirum</td>
										  ...
										  <tr>
												<td width="0.5%">3</td>
												<td width="0.5%">12.22.20.22.04.11.03</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Dirops</td>
										  ...
										  <tr>
												<td width="0.5%">4</td>
												<td width="0.5%">12.22.20.22.04.11.04</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Dirkeu</td>
										  ...
										  <tr>
												<td width="1%">5</td>
												<td width="1%">12.22.20.22.04.11.05</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Divisi Umum</td>
										  ...
										  <tr>
												<td width="0.5%">6</td>
												<td width="0.5%">12.22.20.22.04.11.06</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Divisi Keuangan</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH RUANGAN ASSET</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
