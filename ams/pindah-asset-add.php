                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="form-group row">
					  ...
					  <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						 <div class="form-group row">
						<div class="col-lg-12">
                          <label>Lokasi / Ruangan Asset Awal :</label>
                         <input type="text" class="form-control form-control-sm" placeholder="Ruang Dirut" disabled>
                        </div>
					  ...
					  <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						 <div class="form-group row">
						<div class="col-lg-12">
                          <label>Lokasi Asset / Ruangan Tujuan :</label>
