			...
			<div class="row">
				<div class="col-xl-8">
					...
					<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
						<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Rincian Pembayaran</div><br>
						<div class="kt-portlet__body">
							...
							<table class="table table-striped table-bordered table-hover table-checkable">
																				<thead>
																					<tr>
																					  <th width="2%" bgcolor="#f7fcff">#</th>
																						...
																						<th width="15%" bgcolor="#f7fcff">Atas Penerimaan</th>
								...
								<optgroup label="Beban Lainnya" class="a">
									...
									<option data-subtext="720007">Beban Diluar Usaha Lainnya</option>
																						...
																						<td><input type="text" class="form-control form-control-sm" placeholder="Belanja Server CMS"></td>
