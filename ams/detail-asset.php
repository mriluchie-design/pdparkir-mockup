					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                      ...
                      <div class="col-lg-4">
                          <label>Kategori Asset :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="Bangunan" disabled>
                        </div>
						<div class="col-lg-4">
                          <label>Asset Berwujud :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="Ya" disabled>
                        </div>
						<div class="col-lg-4">
                          <label>Kode Barang :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="02.06.02.06.15" disabled>
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
<div class="col-lg-6">
                         ...
                         <input type="text" class="form-control form-control-sm" placeholder="01/01/2019" disabled>
                      </div>
                        </div>
						<div class="col-lg-6">
						...
						<div class="form-group row">
<div class="col-lg-12">
                          <label>Catatan Asset :</label>
                          <div class="form-group">
                         <textarea class="form-control" id="exampleTextarea" rows="2" style="margin-top: 0px; margin-bottom: 0px; height: 55px;" disabled>RUANGAN PERLENGKAPAN KEADAAN FISIK BARANG BAGIAN DEPAN BAIK ,BAGIAN  BELAKANG  DAN BAWAH RUSAK BERAT</textarea>
                      </div>
                        </div>
