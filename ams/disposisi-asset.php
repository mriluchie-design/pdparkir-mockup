							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="disposisi-asset-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Buat Disposisi Asset</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">ID<br>Disposisi Asset</th>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Lokasi<br> / Ruangan</th>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Status<br>
												Disposisi Asset</th>
											...
											<tr>
											  ...
											  <th width="10%" bgcolor="#f7fcff">Pengajuan</th>
											  <th width="10%" bgcolor="#f7fcff">Disposisi</th>
										    </tr>
										</thead>
										<tbody>
											<tr>
												<td id="kt_table_1">1</td>
												<td id="kt_table_1">0001.DAS.PMR.2023</td>
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-success btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="Dijual" data-html="true"><i class="fa fa-calculator"></i></button></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-disposisi-asset.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="edit-disposisi-asset.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td id="kt_table_1">0002.DAS.PMR.2023</td>
												<td id="kt_table_1">0001/01/KIR/PMR/2003</td>
										  ...
										  <tr>
												...
												<td id="kt_table_1">0003.DAS.PMR.2023</td>
										  ...
										  <tr>
												...
												<td id="kt_table_1">0004.DAS.PMR.2023</td>
