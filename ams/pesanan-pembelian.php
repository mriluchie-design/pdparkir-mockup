	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="pesanan-pembelian-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Pesanan Pembelian</button>
...
<label class="dropdown-item"><input type="checkbox" name="terima">Terima (%)</label>
<label class="dropdown-item"><input type="checkbox" name="diskonPersen">Diskon %</label>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="kurs">Sisa Uang Muka</th>
																						...
																						<th bgcolor="#f7fcff" class="terima">Terima (%)</th>
																						<th bgcolor="#f7fcff" class="diskonPersen">Diskon %</th>
