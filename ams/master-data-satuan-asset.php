					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="30%" bgcolor="#f7fcff">Satuan Asset</th>
										...
										<tbody>
											<tr>
												<td width="0.5%">1</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Box</td>
										  ...
										  <tr>
												<td width="0.5%">2</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Pieces</td>
										  ...
										  <tr>
												<td width="0.5%">3</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Bungkus</td>
										  ...
										  <tr>
												<td width="0.5%">4</td>
												<td width="7%" align="left" valign="left" style="text-align:left">Unit</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH SATUAN ASSET</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
