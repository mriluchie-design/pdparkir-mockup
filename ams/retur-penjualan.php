	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="retur-penjualan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Retur Penjualan</button>
...
<label class="dropdown-item"><input type="checkbox" name="diskon">Dsikon %</label>
