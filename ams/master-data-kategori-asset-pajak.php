				...
				<form class="kt-form">
					<div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-lg-3">
                                <label>Nama Kategori Asset Pajak :</label>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" bgcolor="#f7fcff" id="kt_table_2">%<br>Tarif Penyusutan</th>
											  <th width="20%" bgcolor="#f7fcff">Nama Kategori Asset Pajak</th>
											  <th width="5%" bgcolor="#f7fcff">Perkiraan Umum<br>(Tahun)</th>
											  <th width="5%" bgcolor="#f7fcff">Metode Penyusutan</th>
											  <th width="1%" bgcolor="#f7fcff">Aksi</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
												<td width="0.5%" align="right">1</td>
												<td width="0.5%" align="right">5</td>
												<td width="0.5%">Bangunan Permanen</td>
												<td width="0.5%" align="right">20</td>
						
												<td width="7%" align="left" valign="left" style="text-align:left">Metode Garis Lurus</td>
										  ...
										  <tr>
												<td width="0.5%" align="right">2</td>
												<td width="0.5%" align="right">10</td>
												<td width="0.5%">Bangunan Semi Permanen</td>
												<td width="0.5%" align="right">10</td>
										  ...
										  <tr>
												<td width="0.5%" align="right">3</td>
												<td width="0.5%" align="right">50</td>
												<td width="0.5%">Saldo Menurun Golongan I</td>
												<td width="0.5%" align="right">4</td>
						
												<td width="7%" align="left" valign="left" style="text-align:left">Metode Saldo Menurun</td>
							...
							<!--begin::Modal 2-->
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH KATEGORI ASSET PAJAK</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
                              ...
                              <option value="2">Metode Angka Tahun</option>
												...
												<div class="col-lg-6">
														...
														<input type="text" class="form-control form-control-sm" style="text-align:right"  placeholder="" aria-describedby="basic-addon1">
