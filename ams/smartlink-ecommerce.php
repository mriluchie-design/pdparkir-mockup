...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
			...
			<a href="eCommerce-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Smartlink-eCommerce</button>
		...
		<form class="kt-form">
			<div class="kt-portlet__body">
				<div class="form-group row">
					<div class="col-lg-3">
						<label class="">Nama eCommerce:</label>
						<input type="text" class="form-control form-control-sm " placeholder="">
					</div>
					<div class="col-lg-3">
						<label class="">Nama Toko:</label>
						<input type="text" class="form-control form-control-sm " placeholder="">
					</div>
				</div>
			</div>
	...
	<div class="kt-portlet kt-portlet--mobile ">
		<div class="kt-portlet__body">
			...
			<table class="table table-striped table-bordered table-hover table-checkable">
				<thead>
					<tr>
						<th width="80%" bgcolor="#f7fcff">Nama eCommerce</th>
						<th width="15%" bgcolor="#f7fcff">Nama Toko</th>
