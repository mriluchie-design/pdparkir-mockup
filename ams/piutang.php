					...
					<div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample1">
						<div class="card">
							<div class="card-header" id="headingOne">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1">
									Faktur Belum Lunas
									<small>Menampilkan faktur-faktur yang belum dilunasi</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingTwo">
								<div class="card-title d-grid collapsed kt-font-danger" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
									Faktur Belum Lunas per Pelanggan
									<small>Menampilkan total faktur dari pelanggan yang belum lunas</small> </div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree1">
								<div class="card-title collapsed d-grid kt-font-danger" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
									Umur Piutang
									<small>Menampilkan umur dari piutang pelanggan yang belum lunas</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree2">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree2" aria-expanded="false" aria-controls="collapseThree1">
									...
									<small>Menampilkan nilai faktur, penerimaan dan retur per pelanggan</small>
								</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree3">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree1">
									Histori Piutang
									<small>Menampilkan transaksi detail dari piutang pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree5">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree5" aria-expanded="false" aria-controls="collapseThree1">
									...
									<small>Menampilkan rata-rata hari pelanggan membayar tagihan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading6">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapseThree1">
									...
									<small>Menampilkan umur dari piutang faktur-faktur yang belum lunas</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading7">
								<div class="card-title collapsed d-grid kt-font-primary" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapseThree1">
									Grafik Umur Piutang
									<small>Menampilkan grafik umur dari piutang pelanggan yang belum lunas</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading8">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapseThree1">
									...
									<small>Menampilkan rincian transaksi faktur, penerimaan dan retur per pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading9">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapse9" aria-expanded="false" aria-controls="collapseThree1">
									Pernyataan Piutang
									<small>Menampilkan pernyataan rincian piutang kepada pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading10">
								<div class="card-title collapsed d-grid kt-font-primary" data-toggle="collapse" data-target="#collapse10" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Grafik Rata-rata Pembayaran Pelanggan
									<small>Menampilkan grafik rata-rata hari pelanggan membayar tagihan per bulan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree11">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree11" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Pembayaran Faktur
									<small>Menampilkan daftar pembayaran atas faktur-faktur</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree12">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree12" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Pembayaran PPh Penjualan
									<small>Menampilkan daftar pembayaran atas pemotongan pajak penghasilan penjualan yang di setor sendiri</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree13">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree13" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									...
									<small>Menampilkan daftar penerimaan pembayaran dari pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree14">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree14" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Rincian Penerimaan Penjualan
									<small>Menampilkan rincian daftar penerimaan pembayaran dari pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree15">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree15" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Daftar Pelanggan
									<small>Laporan yang berisi daftar pelanggan</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree16">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree16" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Rincian Tukar Faktur
									<small>Laporan yang berisi rincian faktur pada Tukar Faktur</small>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree17">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree17" aria-expanded="false" aria-controls="collapseThree1" style="font-weight:bold">
									Limit Piutang Pelanggan
									<small>Laporan yang berisi daftar pelanggan beserta sisa limit piutang yang masih diberbolehkan</small>
								</div>
							</div>
