							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="pindah-asset-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Buat Perpindahan Asset</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th colspan="2" bgcolor="#f7fcff">Tanggal</th>
												<th colspan="2" bgcolor="#f7fcff">Lokasi / Ruangan</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Kantor</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Dibuat<br>Oleh</th>
												<th width="3%" rowspan="2" bgcolor="#f7fcff">Status Verifikasi</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
											</tr>
											<tr>
											  <th width="8%" bgcolor="#f7fcff">Beli</th>
											  <th width="8%" bgcolor="#f7fcff">Pakai</th>
											  <th width="8%" bgcolor="#f7fcff">Pengajuan</th>
											  <th width="8%" bgcolor="#f7fcff">Pindah</th>
											  <th width="11%" bgcolor="#f7fcff">Asal</th>
										...
										<tbody>
											<tr>
												...
												<td id="kt_table_1">12 Oktober 2019</td>
												<td id="kt_table_1">12 Oktober 2019</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Dirut</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Dirops</td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-pindah-asset.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="history-pindah-asset.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-info-circle"></i>
																				<span class="kt-nav__link-text">History Perpindahan</span>
																			</a>
																		</li>
																		

																		<li class="kt-nav__item">
																			<a href="edit-pindah-asset.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td id="kt_table_1">12 Oktober 2019</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Dirops</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Divisi Umum</td>
												<td align="center" valign="middle" style="text-align:center">Pusat</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
										  ...
										  <tr>
												...
												<td id="kt_table_1">12 Oktober 2019</td>
												<td id="kt_table_1">12 Oktober 2019</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Divisi Keuangan</td>
												<td width="1%" align="center" valign="middle" style="text-align:left">Divisi Produksi</td>
												<td align="center" valign="middle" style="text-align:center">Pusat</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
