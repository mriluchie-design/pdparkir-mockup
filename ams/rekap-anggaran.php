		...
		<div class="kt-subheader__toolbar">
			...
			<!--end:: Widgets/Stats-->
																			...
																			<table class="table table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																					  ...
																					  <th bgcolor="#f7fcff" class="nomor">Posting</th>
														...
														<img src="../assets/media/users/100_11.jpg" alt="image">
																					  ...
																					  <td width="3%" nowrap style="text-align:center"><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Menunggu Persetujuan"><i class="fa fa-clock"></i></button></td>
