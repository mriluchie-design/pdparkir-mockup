							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="asset-add.php" class="btn btn-info btn-sm">
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="20%" bgcolor="#f7fcff" rowspan="2">Nama Asset</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Kategori<br>Asset</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Asset<br>Berwujud</th>
												<th width="1%" colspan="2" bgcolor="#f7fcff">Tanggal </th>
												<th width="1%" colspan="2" bgcolor="#f7fcff">Penyusutan</th>
												...
												<th width="9%" rowspan="2" bgcolor="#f7fcff">Keadaan Barang</th>
