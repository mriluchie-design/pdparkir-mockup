					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                      ...
                      <div class="col-lg-4">
						...
						<div class="col-lg-4">
                          ...
                          <input type='text' class="form-control form-control-sm" id="kt_inputmask_2" type="text" />
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
...
<div class="col-lg-12">
                          ...
                          <div class="form-group">
                         <textarea class="form-control" id="exampleTextarea" rows="2" style="margin-top: 0px; margin-bottom: 0px; height: 55px;"></textarea>
                      </div>
                        </div>
...
<div class="col-lg-5">
					...
					<div class="col-xl-2">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Foto Asset</div><br><br>
										 <div class="kt-portlet__body">
