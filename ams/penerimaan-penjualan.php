	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
				...
				<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
					...
					<a href="penerimaan-penjualan-add.php" class="btn btn-info btn-sm">
				<i class="fa fa-plus"></i>Buat Penerimaan Penjualan</button>
...
<label class="dropdown-item"><input type="checkbox" name="tanggalCek" checked>Tanggal Cek</label>
...
<label class="dropdown-item"><input type="checkbox" name="bank" checked>Bank</label>
...
<label class="dropdown-item"><input type="checkbox" name="kreditTerpakai">Kredit Terpakai</label>
<label class="dropdown-item"><input type="checkbox" name="sisaKredit">Sisa Kredit</label>
<label class="dropdown-item"><input type="checkbox" name="bayar">Bayar (Kode Unik)</label>
<label class="dropdown-item"><input type="checkbox" name="pakaiKredit" checked>Pakai Kredit</label>
<label class="dropdown-item"><input type="checkbox" name="pembuatData">Pembuat Data</label>
<label class="dropdown-item"><input type="checkbox" name="metodeBayar">Metode Bayar</label>
<label class="dropdown-item"><input type="checkbox" name="nilaiPembayaran" checked>Nilai Pembayaran</label>
<label class="dropdown-item"><input type="checkbox" name="fakturDibayar">Faktur Dibayar</label>
<label class="dropdown-item"><input type="checkbox" name="diskon">Diskon</label>
<label class="dropdown-item"><input type="checkbox" name="nilaiBayar">Nilai Bayar</label>
</form>
</div>
				</div>
	</div>
																			...
																			<table class="table table-striped table-bordered table-hover table-resizable">
																				<thead>
																					<tr>
																						...
																						<th bgcolor="#f7fcff" class="bank">Bank</th>
																						...
																						<th bgcolor="#f7fcff" class="kreditTerpakai">Kredit Terpakai</th>
																						<th bgcolor="#f7fcff" class="sisaKredit">Sisa Kredit</th>
																						<th bgcolor="#f7fcff" class="bayar">Bayar (Kode Unit)</th>
																						<th bgcolor="#f7fcff" class="pakaiKredit">Pakai Kredit</th>
																						<th bgcolor="#f7fcff" class="pembuatData">Pembuat Data</th>
																						<th bgcolor="#f7fcff" class="metodeBayar">Metode Bayar</th>
																						<th bgcolor="#f7fcff" class="nilaiPembayaran">Nilai Pembayaran</th>
																						<th bgcolor="#f7fcff" class="diskon">Diskon</th>
																						<th bgcolor="#f7fcff" class="nilaiBayar">Nilai Bayar</th>
																					</tr>
																				</thead>
																				<tbody>
																					<tr>
																						...
																						<td class="void"></td>
																						<td class="cabang"></td>
																						<td class="kreditTerpakai"></td>
																						<td class="sisaKredit"></td>
																						<td class="bayar"></td>
																						<td class="pakaiKredit"></td>
																						<td class="pembuatData"></td>
																						<td class="metodeBayar"></td>
																						<td class="nilaiPembayaran"></td>
																						<td class="diskon"></td>
																						<td class="nilaiBayar"></td>
																				  </tr>
																					<tr>
																						<td class="nomor"></td>
																						<td class="tanggal"></td>
