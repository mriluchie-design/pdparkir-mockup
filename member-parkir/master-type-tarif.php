					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Type Tarif</th>
										...
										<tbody>
											<tr>
												<td>1</td>
												<td align="left" valign="left" style="text-align:left">Sekali Parkir</td>
											...
											<tr>
												<td>2</td>
												<td align="left" valign="left" style="text-align:left">Harian</td>
										  ...
										  <tr>
												<td>3</td>
												<td align="left" valign="left" style="text-align:left">Mingguan</td>
										  ...
										  <tr>
												<td>3</td>
												<td align="left" valign="left" style="text-align:left">Bulanan</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH TYPE TARIF</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
