							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Detail Kendaraan Member Perusahaan Suspend
									</h3>
...
<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
																							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Suspend</div><br>
																							<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
																					<div class="col-lg-2">
						...
						<div class="col-lg-2">
																						<label>Waktu Suspend :</label>
																						<input type="text" class="form-control form-control-sm" value="11 Agustus 2023 / 10:30:00 WITA " placeholder="31 Desember 2022" id="kt_datepicker_2" disabled>
																					</div>
																					<div class="col-lg-3">
																						<label>Keterangan Suspend :</label>
																						<input type="text" class="form-control form-control-sm" value="Duplikat" placeholder="31 Desember 2022" id="kt_datepicker_2" disabled>
																					</div>
