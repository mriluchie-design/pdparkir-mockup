					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Metode<br>
											  Transaksi</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap style="text-align:left">17 Agustus 2023 - 17:00</td>
										  ...
										  <tr>
												...
												<td nowrap style="text-align:left">17 Agustus 2023 - 16:00</td>
										  ...
										  <tr>
												...
												<td nowrap style="text-align:left">17 Agustus 2023 - 15:00</td>
												<td nowrap style="text-align:center">Mobil</td>
												<td nowrap style="text-align:left"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="20.000" aria-describedby="basic-addon1">
										  ...
										  <tr>
												...
												<td nowrap style="text-align:left">17 Agustus 2023 - 14:00</td>
												<td nowrap style="text-align:center">Motor</td>
												<td nowrap style="text-align:left"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="20.000" aria-describedby="basic-addon1">
										  ...
										  <tr>
												...
												<td nowrap style="text-align:left">17 Agustus 2023 - 13:00</td>
												<td nowrap style="text-align:center">Mobil</td>
												<td nowrap style="text-align:left"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="20.000" aria-describedby="basic-addon1">
