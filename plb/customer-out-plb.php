					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">QR Code<br>Customer<br>PLB</th>
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Zona</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Wilayah</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Alamat</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Tipe<br>Customer</th>
