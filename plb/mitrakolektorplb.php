					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Qrcode<br>Jukir PLB</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">ID Jukir PLB</th>
											...
											<tr style="text-align:center">
											  ...
											  <th width="2%" bgcolor="#f7fcff">Titik Parkir / Customer</th>
