 ...
 <div class="row">
     ...
     <div class="col-xl-6">
					  ...
					  <div class="col-lg-4">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="14722IN-PLB112024">
                        </div>
						<div class="col-lg-4" >
                          <label>Kwitansi :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="14966TKMPLB012025">
                        </div>
						<div class="col-lg-2">
						...
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						  <div class="form-group row">
						  <div class="col-lg-4" >
                          <label>Tarif Pengelolaan ( / Bulan ) :</label>
						...
						<div class="col-lg-4" >
                          <label style="color:#a2050c">Nilai Setoran :</label>
                          <div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="300.000" aria-describedby="basic-addon1">
																					    <div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
						...
						<div class="col-lg-4">
                          <label style="color:#a2050c">Sisa Setoran :</label>
                          <div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
									...
									<!--begin::Portlet-->
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Customer</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
											<div class="form-group row">
					  ...
					  <div class="col-lg-4">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="1676MJPPLBI25">
                        </div>
						<div class="col-lg-4">
                          <label class="">Nama Customer :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="BPJS Ketenagakerjaan">
                        </div>
						...
						<div class="col-lg-4">
                          <label style="color:#a2050c">Kolektor :</label>
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																		...
																		<li class="kt-nav__item">
																			<a href="print-setoran-customer.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon2-print"></i>
																				<span class="kt-nav__link-text">Cetak Tanda Terima</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="edit-setoran-customer.php" class="kt-nav__link">
