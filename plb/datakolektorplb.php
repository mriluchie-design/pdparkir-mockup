							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_add_kolektor"><i class="fa fa-plus-circle"></i>Tambah Data</button>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											...
											<tr style="text-align:center">
											  ...
											  <th width="4%" bgcolor="#f7fcff">Berakhir</th>
											  <th width="1%" bgcolor="#feffed">Zona</th>
										...
										<tbody>
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="000000000001<hr>Department<hr>Divisi" data-html="true" >
												...
												<td nowrap style="text-align:left">Baru, Bulogading, Maloku</td>
...
<!--begin::Modal 1-->
									<div class="modal fade" id="modal_add_kolektor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-danger">FORM TAMBAH KOLEKTOR PLB</h3>
											</div>
