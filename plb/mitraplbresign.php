					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Nama Jukir PLB</th>
											...
											<tr style="text-align:center">
											  ...
											  <th width="7%" bgcolor="#f7fcff">Titik Parkir / Customer</th>
										...
										<tbody>
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="000000000001" data-html="true" >
