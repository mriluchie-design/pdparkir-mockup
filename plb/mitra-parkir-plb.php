        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Data Mitra Juru Parkir Langganan Bulanan
                </h3>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <a href="mitra-plb-add.php" class="btn btn-info btn-sm">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">QR Code<br>Jukir PLB</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">ID<br>Jukir PLB</th>
											  
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Foto</th>
											  <th width="6%" rowspan="2" bgcolor="#f7fcff">Nama Jukir PLB</th>
											...
											<tr style="text-align:center">
											  ...
											  <th width="5%" bgcolor="#f7fcff">Titik Parkir<br>/ Customer </th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap>Coto Nusantara</td>
												...
												<td style="text-align:left" nowrap>24 September 2008</td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="cetak-id-card-jukir-plb.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-address-card"></i>
																				<span class="kt-nav__link-text">Cetak ID Card</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<div class="kt-nav__link" data-toggle="modal" data-target="#serah-terima-id-card-plb">
																		...
																		<li class="kt-nav__item">
																			...
																			<a href="jukir-plb-remove.php" class="kt-nav__link">
																		<li class="kt-nav__item">
																				<i class="kt-nav__link-icon fa fa-user-slash"></i>
																				<span class="kt-nav__link-text">Berhentikan Jukir</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="jukir-plb-edit-area.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td nowrap style="text-align:center">06:00:00</td>
												<td nowrap style="text-align:center">12:00:00</td>
												<td nowrap style="text-align:center">Pria</td>
												<td style="text-align:left" nowrap>24 September 2008</td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-facebook btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="082244444436"><i class="fa fa-phone-square"></i></button></td>
												<td width="1%" style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Diserahkan<hr>Muhammad Nasrullah, S.Kom<br>31 Desember 2018 - 14:30 WITA" data-html="true">
															<i class="fa fa-barcode"></i>
												...
												<td width="1%" style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Aktif<hr>31 Desember 2018 - 14:30 WITA" data-html="true">
														...
														<td style="text-align:center" nowrap><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"><img src="../assets/media/users/100_1.jpg" alt="image" /></a></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="row">
								<div class="col-xl-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">History Penyerahan Rompi PLB</div><br><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
