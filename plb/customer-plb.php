        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Data Customer Parkir Langganan Bulanan
                </h3>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <a href="customer-plb-add.php" class="btn btn-info btn-sm">
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="customer-remove.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-user-slash"></i>
																				<span class="kt-nav__link-text">Berhentikan Customer</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
