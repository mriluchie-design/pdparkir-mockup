...
function goBack() {
  window.history.back();
											 ...
											 <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#kt_modal_2" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-user-slash"></i>Berhentikan Mitra</button>
											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="mitra-detail-remove.php" class="kt-widget__item kt-widget__item--active">
														...
														<a href="data-penugasan-mitra-remove.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
