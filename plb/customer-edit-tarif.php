        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                   ...
                   Penyesuaian Tarif Parkir Langganan Bulanan
                </h3>
            </div>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Zona</th>
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Wilayah</th>
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Alamat</th>
											  ...
											  <th width="1%" colspan="2" bgcolor="#f7fcff">SKB</th>
											    ...
											    <th width="1%" rowspan="2" bgcolor="#f7fcff">Verifikasi Perubahan Tarif</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">001/30.SKB-PLB/I/2023</td>
												<td style="text-align:left" nowrap>BPJS Ketenagakerjaan</td>
												<td nowrap="nowrap" style="text-align:left">Biringkanaya</td>
												<td nowrap="nowrap" style="text-align:left">Bakung</td>
												<td nowrap="nowrap" style="text-align:left">Jl. Urip Sumoharjo No 344</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--info kt-badge--sm kt-badge--inline">Silver</span></td>
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="detail-tarif.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fab fa-readme"></i>
																				<span class="kt-nav__link-text">Detail Tarif</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="ubah-tarif-plb.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-user-edit"></i>
																				<span class="kt-nav__link-text">Ubah Tarif</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="skb-cetak-terbaru.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak SKB Terbaru</span>
																			</a>
																		</li>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">002/30.SKB-PLB/I/2023</td>
												<td style="text-align:left" nowrap>BPJS Ketenagakerjaan</td>
												<td nowrap="nowrap" style="text-align:left">Biringkanaya</td>
												<td nowrap="nowrap" style="text-align:left">Bulurokeng</td>
												<td nowrap="nowrap" style="text-align:left">Jl. Urip Sumoharjo No 344</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--warning kt-badge--sm kt-badge--inline">Gold</span></td>
												<td style="text-align:center" nowrap>24/01/2023<br>06:00:00 WITA</td>
												<td style="text-align:center" nowrap>25/01/2023<br>06:00:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"> <img src="../assets/media/users/100_13.jpg" alt="image" /> </a></td>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:center">003/30.SKB-PLB/I/2023</td>
												<td style="text-align:left" nowrap>BPJS Ketenagakerjaan</td>
												<td nowrap="nowrap" style="text-align:left">Biringkanaya</td>
												<td nowrap="nowrap" style="text-align:left">Katimbang</td>
												<td nowrap="nowrap" style="text-align:left">Jl. Urip Sumoharjo No 344</td>
												<td nowrap style="text-align:center"><span class="kt-badge kt-badge--danger kt-badge--sm kt-badge--inline">Platinum</span></td>
												<td style="text-align:center" nowrap>24/01/2023<br>06:00:00 WITA</td>
												<td style="text-align:center" nowrap>25/01/2023<br>06:00:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP PEGAWAI&lt;hr&gt;UMAR MALIK, SE&lt;hr&gt;082244444436" data-html="true"> <img src="../assets/media/users/100_13.jpg" alt="image" /> </a></td>
