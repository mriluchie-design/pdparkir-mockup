        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Survey Calon Customer Parkir Langganan Bulanan
                </h3>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <a href="customer-survey-plb-add.php" class="btn btn-info btn-sm">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Qrcode<br>Calon Customer<br>PLB</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">ID<br>Calon Customer PLB</th>
											  
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">Nama Calon<br>Customer</th>
											...
											<tr>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="customer-survey-detail.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Profil Calon Customer</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="customer-detail.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-user-plus"></i>
																				<span class="kt-nav__link-text">Jadikan Customer</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
