					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="78%" bgcolor="#f7fcff">Jenis Kendaraan</th>
											  <th width="20%" bgcolor="#f7fcff">Tarif Satuan</th>
										...
										<tbody>
											<tr>
												<td>1</td>
												<td align="left" valign="left" style="text-align:left">Motor</td>
												<td align="left" valign="left" style="text-align:left"><div class="input-group input-group-sm">
											...
											<tr>
												<td>2</td>
												<td align="left" valign="left" style="text-align:left">Mobil</td>
												<td align="left" valign="left" style="text-align:left"><div class="input-group input-group-sm">
												  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
