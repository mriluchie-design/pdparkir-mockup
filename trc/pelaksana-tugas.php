    ...
    <td><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Pusat"></td>
					...
					<div class="col-lg-4">
					  ...
					  <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Team Reaksi Cepat">
                        </div>
                        </div>
					  ...
					  <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="15 Agustus 2023">
                        </div>
						<div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                          <div id="kt_repeater_2">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_2">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><textarea class="form-control" disabled="disabled" id="exampleTextarea" rows="2" placeholder="Uraian Tugas 1"></textarea></td>
																									<td style="text-align:center"><input type="text" disabled="disabled" class="form-control form-control-sm" placeholder="10"></td>
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><textarea class="form-control" disabled="disabled" id="exampleTextarea" rows="2" placeholder="Uraian Tugas 2"></textarea></td>
																									<td style="text-align:center"><input type="text" disabled="disabled" class="form-control form-control-sm" placeholder="10"></td>
																									<td style="text-align:center"><a href="javascript:;" data-repeater-delete="" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="dropdown"><i class="fa flaticon2-trash"></i></a></td>
