									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Pejabat<br>Pembuat</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Input</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Pemberi<br>Tugas</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Pelaksana<br>Tugas</th>
												<th width="35%" bgcolor="#feffed" rowspan="2">Uraian Tugas</th>
												<th width="11%" bgcolor="#feffed" rowspan="2">Kategori</th>
											...
											<tr>
											  <th width="10%" bgcolor="#feffed">Mulai </th>
												<th width="10%" bgcolor="#feffed">Deadline </th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center"><span class="kt-badge kt-badge--info kt-badge--md kt-badge--inline">Auto</span></td>
											  ...
											  <td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												...
												<td nowrap="nowrap" style="text-align:center"><button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#modal_perjalanan_dinas"><i class="fa fa-user-tie"></i>Lihat</button></td>
                          ...
                          <div class="progress">
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-tugas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="pelaksana-tugas.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-user-circle"></i>
																				<span class="kt-nav__link-text">Pelaksana Tugas</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
  ...
  <div class="modal fade" id="modal_perjalanan_dinas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md" role="document">
									<div class="modal-content">
										...
										<div class="modal-header">
										<span class="modal-title" id="exampleModalLabel"><i class="flaticon2-list-1" style="color:#ef5325"></i>&nbsp;&nbsp;<span style="color:#0961ae";>DATA PEGAWAI PELAKSANA TUGAS</span></span>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
